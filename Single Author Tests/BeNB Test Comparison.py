...
data = pd.read_csv('C:\\Coding\\Research\\Summer 2023\\Stylometry Neural Networks\\Datasets\\author two dataset\\Bert, two, 30 weighted.csv')
print(data.shape[0])
print(data.shape[1])
data = normalize(data)
drop = ['File Name', 'Written', 'Row Range', 'File Path']
data = add_clustering(data, drop)
