...
public class Solution {
    ...
    private static void mainLoop(int caseId, BufferedReader reader, int b) throws IOException {
        ...
        while (result.bytesFound < b) {
            ...
            checkMutation(b, result, byteRequester);
    ...
    private static void checkMutation(int b, Result result, ByteRequester byteRequester) throws IOException {
        if (result.bytesFound < b && byteRequester.trials % 10 == 1) {
    ...
    private static class Result {
        ...
        // if same : same or reverse
        // else : complement or (complement + reverse)
