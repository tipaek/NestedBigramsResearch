...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int caseIndex = 1; caseIndex <= numberOfCases; caseIndex++) {
			...
			int diagonalSum = getDiagonalSum(integersCeiling, permutations);
	...
	private static int getDiagonalSum(int integersCeiling, List<List<Integer>> permutations) {
		int diagonalSum = 0;
		for(int i = 0; i < integersCeiling; i++) {
