...
public class Solution {
    ...
    static boolean intervalDansListe(Intervalle intervalle, ArrayList<Intervalle> liste) {
        ...
        for (Intervalle value : liste) {

            if ((intervalle.deb == value.deb) || (intervalle.fin == value.fin) ||
                    ((intervalle.deb < value.fin) && (value.deb < intervalle.fin)) ||
                    ((intervalle.deb < value.deb) && (intervalle.fin > value.fin))) {
