...
public class Solution{
  ...
  public static void main(String[] args) throws CloneNotSupportedException {
    ...
    scanner.nextLine();
    ArrayList<SqMatrix> arrayList=new ArrayList<>(t);
...
class Calculator {
  ...
  private ArrayList<SqMatrix> arraylist;

  public Calculator(ArrayList<SqMatrix> arraylist) {
    this.arraylist = arraylist;
  }

  public int trace(int index){

    SqMatrix sqMatrix=this.arraylist.get(index);
    int n=sqMatrix.getN();
    int trace=0;
    for (int i=0;i<n;i++)
  ...
  public int raw(int index) throws CloneNotSupportedException {
    ...
    int raw=0;
    SqMatrix sqMatrix=this.arraylist.get(index).clone();
    InsertSort insertSort;
    ArrayList<Integer> arrayList;
    int n=sqMatrix.getN();
    for (int i=0;i<n;i++){
      arrayList=sqMatrix.getinnerArrayLists(i);
      insertSort = new InsertSort(arrayList);
...
class SqMatrix implements Cloneable{
  ...
  @Override
  public SqMatrix clone() throws CloneNotSupportedException{

    SqMatrix cloned = (SqMatrix)super.clone();
