class Main {
    ...
    public static void main(String[] args) {
        ...
        int tests = 1;// = Integer.valueOf(JOptionPane.showInputDialog(null, "Enter number of tests you wish to run"));
        ...
        for (int t = 1; t <= tests; t++) {
            ...
            s = "12320";//JOptionPane.showInputDialog(null, "enter integer");
