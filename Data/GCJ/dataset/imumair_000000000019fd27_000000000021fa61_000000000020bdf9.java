...
public class Solution {
	...
	public static boolean valid(String in, ArrayList<String> L){
		...
		for (int i =0; i<L.size(); i++ ){
			...
			if( (startnew>startold && startnew<endold)|| (endnew>startold && endnew<endold) || (startnew==startold && endnew==endold)||(startnew<startold && startnew<endold)|| (endnew>startold && endnew>endold)){
				out = false;
				break;
			}else {
				out = true;
