...
public class Solution {
	...
	public static final String directory = "/src/jam2020/qualif/problem1";
	...
	public int getNbLinesToReadForCurrentTestCaseOnTopOfCurrentLine(String firstTestCaseLine) {
		return Integer.valueOf(firstTestCaseLine);
	}

	// Finally do the real work !
	public String compute(String[] input) {

		int[][] matrix = new int[Integer.valueOf(input[0])][Integer.valueOf(input[0])];
