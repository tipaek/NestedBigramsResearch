 ...
 * Loop through from i=0 to i=matrix.length
 * Add to sum value the value at row[i] and column[i]
 * 
 * Check repeating values in row/column:
 * Use a HashSet
 * Iterate through all rows, input number in HashSet
 * Check if it contains the value, if it does, increment and break
 */
