...
class ProblemA {
    public static void main(String[] args) {
        ...
        while(cases<=T){
            ...
            System.out.println("Case #"+cases+" "+calculateTrace(N,arr)+" "+rows+" "+cols);
            cases++;
        }
    }

    static Integer calculateTrace(Integer N, Integer[][] arr){
        int sum = 0;
        for(int i=0;i<N;i++)
            sum+=arr[i][i];
        return sum;
...
/*    public BiFunction<Integer,Integer[][],Integer> calculateTrace= (N,arr)-> {
