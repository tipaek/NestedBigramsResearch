...
//                    System.out.println(">>> enter validation mode");
                    validatingMode = true;
                    startQuery = 1;
                    endQuery = b;
                }
    ...
    private static Integer[] haveClue(Integer[] initialArray, Integer[] changedArray) {
        ...
        if (!areArraysEqualIgnoreNull(changedArray, initialArray) && areArraysEqualIgnoreNull(changedArray, complemented) && !areArraysEqualIgnoreNull(changedArray, reversed) && !areArraysEqualIgnoreNull(changedArray, both)) {
//            System.out.println(">>> complemented");
            return complemented;
        } else if (!areArraysEqualIgnoreNull(changedArray, initialArray) && !areArraysEqualIgnoreNull(changedArray, complemented) && areArraysEqualIgnoreNull(changedArray, reversed) && !areArraysEqualIgnoreNull(changedArray, both)) {
