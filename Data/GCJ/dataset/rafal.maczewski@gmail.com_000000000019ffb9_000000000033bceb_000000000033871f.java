...
public class Solution {
    ...
    private static void solve(int caseNr, Scanner in) {
        ...
        nodesWithNodeBefore.sort(new Comparator<Node>() {
            @Override
            public int compare(Node o1, Node o2) {
                if (o1.nodesBefore != o2.nodesBefore) {
                    return o1.nodesBefore - o2.nodesBefore;
                }
        ...
        for (int i = 0; i < nodes.size(); i++) {
            ...
            if (n.nodesBefore == nodesBefore) {
                n.updateTime = currentTime;
            } else {
                if (n.updateTime != 0) {
            ...
            for (int j = 0; j < connectedNodes.size(); j++) {
                ...
                if (cc.visited) {
                    ...
                    result[n.connIdxes.get(j)] = latency;
                }
            }
        }
