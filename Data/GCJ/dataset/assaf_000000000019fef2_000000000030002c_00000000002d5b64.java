...
public class Solution {
  ...
  public void interact() {
    ...
    out.println(input.formatResult(String.format("%s", operations.size())));
    for (Pair op : operations) {
      out.println(String.format("%s", op));
    }
    out.flush();
  }
