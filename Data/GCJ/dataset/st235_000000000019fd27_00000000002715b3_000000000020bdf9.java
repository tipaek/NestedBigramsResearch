...
class Solution {
    ...
    private static String solve(List<Activity> activities) {
        ...
        TreeMap<Integer, TreeSet<Command>> lookup = new TreeMap<>();

        for (Activity activity: activities) {
            TreeSet<Command> startCommands = lookup.getOrDefault(activity.start, new TreeSet<>());
            startCommands.add(new Command(ADD, activity));
            lookup.put(activity.start, startCommands);

            TreeSet<Command> endCommands = lookup.getOrDefault(activity.finish, new TreeSet<>());
        ...
        for (Map.Entry<Integer, TreeSet<Command>> entry: lookup.entrySet()) {
