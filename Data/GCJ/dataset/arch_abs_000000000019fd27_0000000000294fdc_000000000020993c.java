...
return (leftGreater); 
    ...
    public static void main(String args[]){
        try{
            ...
            int i, q, j, k, x, y, t, n, ind, count, diff, key, l, r, b, size, rowc, colc, prev, max, sec_max, minglob, minloc, beg, end, begl, endr, ld, up, down, maxele, minele, case_count;
