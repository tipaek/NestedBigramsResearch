...
public class Solution {
   ...
   public static void main(String[] args) {
      ...
      for( int i=1; i<=testCases; i++ ) {
         ...
         List<List<Integer>> list = dfs(1, 1, n-1, 499);
   ...
   public static List<List<Integer>> dfs(int r, int c, long needed, int count) {
      ...
      list = dfs(r+1,c, needed-pt[r+1][c], count-1);
      if( list == null ) {
         list = dfs(r+1,c+1, needed-pt[r+1][c+1], count-1);
         if( list == null ) {
            list = dfs(r,c+1, needed-pt[r][c+1], count-1);
            if( list == null ) {
               list = dfs(r,c-1, needed-pt[r][c-1], count-1);
               if( list == null ) {
                  list = dfs(r-1,c-1, needed-pt[r-1][c-1], count-1);
