    ...
    public static void main(String[] args)
    {
        ...
        for (int testCase = 1; testCase <= T; testCase++)
        {
            ...
            for (int a = 1; a <= 5; a++)
            {
                ...
                out.setCharAt(a - 1, (char)(in.nextInt()+(int)('0')));
            }
            for (int a = B; a >= B-4; a--)
            {
                System.out.println(a);
            ...
            while (out.indexOf("x") != -1 && attempt <= 140)
            {
                if (attempt % 10 == 1)
                {
                    ...
                    if (indexToFlip != -1)
                    {
                        ...
                        attempt++;
                        char checkFlip = (char)(in.nextInt() + (int)('0'));
                    ...
                    if (indexToReverse != -1)
                    {
                        ...
                        attempt++;
                        char checkReverse = (char)(in.nextInt() + (int)('0'));
                ...
                if (isFront)
                {
                    ...
                    out.setCharAt(currentIndex, (char)(in.nextInt()+(int)('0')));
                    attempt++;
                    isFront = false;
                    lastX = currentIndex;
                }
                else
                {
                    ...
                    out.setCharAt(B-lastX-1, (char)(in.nextInt()+(int)('0')));
                    attempt++;
