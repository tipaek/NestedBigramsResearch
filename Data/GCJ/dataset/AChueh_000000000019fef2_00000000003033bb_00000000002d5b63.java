...
//                    System.err.println("RETURN"+81);
                ...
                if(possibleT[1] - possibleT[0] == -1) {
                    if(possibleT[0] == 1000000000) {
                        ++i;
                        T = guess(input, possibleT[0], 0).equals("HIT")?possibleT[0]:possibleT[1];
                    } else {
                        T = possibleT[1];
                    }
...
//                    System.err.println("RETURN"+101);
                ...
                if(possibleB[1] - possibleB[0] == 1) {
                    if(possibleB[0] == -1000000000) {
                        ++i;
                        B = guess(input, possibleB[0], 0).equals("HIT")?possibleB[0]:possibleB[1];
                    } else {
                        B = possibleB[1];
                    }
                    answer[1] = (T + B)/2;
...
//        System.err.println("ANSWER: "+ L +" " + T +" " + R + " " + B);
