...
public class Solution {
  public static void main(String[] args) {
    ...
    for(int t=0; t<numT; t++) {
      ...
      int ans = numDiners; // worst case is you do numDiner cuts - 1 (take the ending cut and keep doing it)
      ...
      for(Map.Entry elem : slices.entrySet()) {
        ...
        // System.out.printf("size=%d freq=%d\n", size, freq);
        ...
        if(numDiners == 3) {
          if(size%2 == 0) {
            ...
            // If there already exists a slice you can make into a half
