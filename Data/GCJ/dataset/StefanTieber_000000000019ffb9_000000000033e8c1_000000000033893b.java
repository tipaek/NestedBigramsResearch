...
class Point {
    ...
    void recalc() {
        ...
        if (Solution.points[left].costInfinite > 0 || Solution.points[left].cost > potLeft) {
            Solution.points[left].cost = potLeft;
            Solution.points[left].costInfinite = 0;
        }
        if (Solution.points[right].costInfinite > 0 || Solution.points[right].cost > potRight) {
            Solution.points[right].cost = potRight;
            Solution.points[right].costInfinite = 0;
        }
        if (Solution.points[jump].costInfinite > 0 || Solution.points[jump].cost > potJump) {
