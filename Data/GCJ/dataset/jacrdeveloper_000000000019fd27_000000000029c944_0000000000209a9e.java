			...
			for (int o = 1; o <= 150; o++) {
				...
				if (o % 10 == 1) {
					...
					if (o == 5) {
						...
						ahoraBuffer.append(mapB[checkPos[3]-2]);
						...
						if (cambioBuffer.toString().equals(ahoraBuffer.toString())) {
							...
							complementedBuffer.append(complementa(mapB[checkPos[3]-2]));
							...
							if (cambioBuffer.toString().equals(complementedBuffer.toString())) {
								...
								reverseBuffer.append(mapB[checkPos[3]-2]);
								...
								if (cambioBuffer.toString().equals(reverseBuffer.toString())) {
									...
									reverseBuffer.append(complementa(mapB[checkPos[3]-2]));
