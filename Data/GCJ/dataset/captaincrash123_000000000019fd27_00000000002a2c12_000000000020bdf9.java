            ...
            for (int j = 0; j < n; j++) {
                for (int k = j + 1; k < n; k++) {
                    if ((int)Math.min(endingTimes[j], endingTimes[k]) - (int)Math.max(startingTimes[j], startingTimes[k]) > 0) {
                        ...
                        intersectionsRange[intersectionCounter][0] = (int)Math.max(startingTimes[j], startingTimes[k]);
                        intersectionsRange[intersectionCounter][1] = (int)Math.min(endingTimes[j], endingTimes[k]) - 1;
