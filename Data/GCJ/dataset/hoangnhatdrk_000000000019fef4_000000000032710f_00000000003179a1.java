...
public class Solution {
    ...
    private static String overrandomized(int u, long[] q, String[] r, int size) {
        ...
        dfs(d, q, r, candidates, dict, 0, (long) (Math.pow(10, u) - 1));

        String s = new String(d);
        return s;
    }

    private static boolean dfs(char[] d, long[] q, String[] r, Set[] candidates, Set dict, int curD, long cap) {
        if (curD > 9) {
            return check(d, q, r, cap);
        }
        ...
        while (i.hasNext()) {
            ...
            if (dict.contains(nextChar)) {
                ...
                d[curD] = nextChar;
                if (dfs(d, q, r, candidates, dict, curD + 1, cap)) {
                    return true;
                } else {
                    dict.add(nextChar);
                }
    ...
    private static boolean check(char[] d, long[] q, String[] r, long cap) {
