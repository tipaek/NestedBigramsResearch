...
public class Solution {
	...
	public int solve(long[] A, int D) {
		if(D == 2) {
			...
			//System.out.println(map + ", " + maxCount + ", " + maxSize);
			...
			for(long a : A) {
				if(map.containsKey(a * 2L)) return 1;
			}
			return 2;
		}
	...
	public static void mainX(String[] args) {
		...
		System.out.println(Q.solve(new long[] {4, 4, 8, 8}, 3));
		System.out.println(Q.solve(new long[] {4, 3, 9, 9}, 3));
		System.out.println(Q.solve(new long[] {4, 3, 8, 8}, 3));
		System.out.println(Q.solve(new long[] {4888888}, 3));
	}
