        ...
        for(int t = 0; t < testCases; t++){//testCases
            ...
            for(int i = 0; i < tasks.length; i++){
                ...
                for(int j = 0; j < tasks.length; j++){
                    if((tasks[j].x > tasks[i].x && tasks[j].x < tasks[i].y)){
            ...
            for(int a = 0; a < tasks.length; a++){
                ...
                for(int b = 0; b < tasks.length; b++){
                    if(tasks[b].x >= lower && tasks[b].y <= upper && a != b) found1 = true;
                    for(int c = 0; c < tasks.length; c++){
                        if(tasks[c].x >= lower && tasks[c].y <= upper && tasks[c].x >=  tasks[b].x && tasks[c].y <= tasks[b].y && b!=c && b != a) found2 = true;
                    }
                }
            }
            if(found1 && found2) output = "IMPOSSIBLE";
            else{
                for(int a = 0; a < N; a++){
