...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for(int z=1; z<=t; z++) {
			...
			boolean[][] mark = new boolean[205][205];
...
//						System.out.println(p.s);
				...
				nx = x+(1<<step);
				ny = y;
				if (nx>-MX && nx<MX && ny>-MX && ny<MX && !mark[MX+nx][MX+ny]) {
					mark[MX+nx][MX+ny] = true;
					queue.add(new int[] {nx, ny, step+1});
					parent[MX+nx][MX+ny] = new Pair(x, y, "E");
				}
				...
				if (nx>-MX && nx<MX && ny>-MX && ny<MX && !mark[MX+nx][MX+ny]) {
					mark[MX+nx][MX+ny] = true;
					queue.add(new int[] {nx, ny, step+1});
					parent[MX+nx][MX+ny] = new Pair(x, y, "W");
				}
				...
				if (nx>-MX && nx<MX && ny>-MX && ny<MX && !mark[MX+nx][MX+ny]) {
					mark[MX+nx][MX+ny] = true;
					queue.add(new int[] {nx, ny, step+1});
					parent[MX+nx][MX+ny] = new Pair(x, y, "N");
				}
				...
				if (nx>-MX && nx<MX && ny>-MX && ny<MX && !mark[MX+nx][MX+ny]) {
					mark[MX+nx][MX+ny] = true;
					queue.add(new int[] {nx, ny, step+1});
					parent[MX+nx][MX+ny] = new Pair(x, y, "S");
				}
			...
			if (!good) {
				...
				println("Case #"+z+": "+sb.reverse().toString());
			}
		}
