...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= times; i++) {
			...
			// Case if endIn = 1440
			if (Integer.parseInt(line.substring(line.indexOf(" ") + 1)) == 1440) {
			...
			if (Integer.parseInt(line2.substring(line2.indexOf(" ") + 1)) == 1440) {
				Arrays.fill(jTime, Integer.parseInt(line2.substring(0, line2.indexOf(" "))),
						Integer.parseInt(line2.substring(line2.indexOf(" ") + 1)), true);
			} else {
				Arrays.fill(jTime, Integer.parseInt(line2.substring(0, line2.indexOf(" "))),
						Integer.parseInt(line2.substring(line2.indexOf(" ") + 1)) + 1, true);
			}
