...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        for(int caseNumber = 0, activityCount, cFinish, jFinish; caseNumber<cases; caseNumber++){
            ...
            getActivities(bufferedReader, activities, activityCount);
    ...
    private static void getActivities(BufferedReader bufferedReader, Activity[] activities, int activityCount) throws IOException {
        String[] activity;
        for(int i=0;i<activityCount;i++){
