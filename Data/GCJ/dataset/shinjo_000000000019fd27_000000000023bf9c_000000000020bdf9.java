...
public class Solution {
    ...
    private static boolean makeSchedule(int i, long[][] scheduleInfo, Stack<Pair> cameron, Stack<Pair> jamie, Stack<String> result, int count) {
        if (i >= count)
            return true;
    ...
    private static boolean scheduleCheck(long[] ints, Stack<Pair> who) {
        for (Pair o : who) {
