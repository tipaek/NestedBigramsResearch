...
public class Solution {
	public static void main(String[] args) {
		...
		for (int i = 1; i <= T; i++) {
			...
			for (int j = 1; j < scheduleList.size(); j++) {
				...
				overlapping = overlapping(schedule, scheduleList, j);
	...
	static String overlapping(Schedule schedule, ArrayList<Schedule> scheduleList, int boundry) {
		String value = "";
