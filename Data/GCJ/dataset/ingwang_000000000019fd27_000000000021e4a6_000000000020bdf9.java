...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for(int tc =1; tc<=T;tc++) {
			...
			PriorityQueue <Job> c = new PriorityQueue <Job>(new Comparator<Job>(){
			...
			PriorityQueue <Job> j = new PriorityQueue <Job>(new Comparator<Job>(){
			...
			for(int i =0 ;i <N;i++) {
				Job now = jobs.get(i);
			//	System.out.printf("now.s =%d e =%d i=%d\n",now.s,now.e,i);
			
			//	System.out.printf("c.peek.e =%d j.peek.e =%d\n",c.peek().e,j.peek().e);
