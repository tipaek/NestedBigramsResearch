...
public class Solution implements Runnable {
    ...
    static boolean interactive = true; //use outGlobal.println()   and   outGlobal.flush()
    ...
    public static class Solver extends  SolverAbstract{
        ...
        private String query(long x, long y) throws IOException {
            outGlobal.println(x + " " + y);
            outGlobal.flush();
            String response  = scanner.nextToken();
            ...
            //System.err.println("Query x,y= "+x+","+y +" ===> "+response);
            return response;
        }
        ...
        protected void solve() throws IOException {
            long dd = A/2;
            for (long x = -MAX; x <= MAX; x+=dd) {
                for (long y = -MAX; y <= MAX; y+=dd){
        ...
        private void findCenter(long x, long y) throws IOException {
            long leftX, rightX;
            {
                long L = -MAX - 1;
                long R = x + 1;
                ...
                leftX = R;
                //System.err.println("found leftX = "+leftX);
            }

            {
                ...
                rightX = L;
                //System.err.println("found rightX = "+rightX);
            }
            ...
            long leftY, rightY;
            {
                ...
                leftY = R;
                //System.err.println("found leftY = "+leftY);
            }
            {
                long L = y - 1;
                long R = MAX + 1;
                ...
                rightY = L;
                //System.err.println("found rightY = "+rightY);
            }

            //System.err.println("leftX, rightX = "+leftX + ","+rightX);
            //System.err.println("leftY, rightY = "+leftY + ","+rightY);

            long xC = (rightX + leftX) / 2;
            long yC = (rightY + leftY) / 2;
            String resC = query(xC, yC);
            if (!"CENTER".equals(resC)){
                throw new RuntimeException("something went wrong");
            }
            System.err.println("found CENTER = "+xC + ","+yC);
        }
    }
    ...
    private void solveAll() throws IOException {
        ...
        if (T==0) {
            if (largeFakeTest) {
                ...
                A = scanner.nextInt();
                B = scanner.nextInt();
                System.err.println(String.format("T=%d, A=%d, B=%d", T, A, B));
            }
        }
