...
public class Solution {
    ...
    private static Integer[] haveClue(Integer[] initialArray, Integer[] changedArray) {
        ...
        for (int i = 0; i < toCompare.size(); i++) {
            ...
            if (shouldAdd && arrEq(currArray, reversed)) {
                shouldAdd = false;
//                break;
            }
        }
        ...
        for (int i = 0; i < toCompare.size(); i++) {
            Integer[] currArray = toCompare.get(i);
            if (shouldAdd && arrEq(currArray, both)) {
                shouldAdd = false;
//                break;
            }
        }
...
//
//
//        if (!arrEq(changedArray, initialArray) && arrEq(changedArray, complemented) && !arrEq(changedArray, reversed) && !arrEq(changedArray, both)) {
//            System.out.println(">>> complemented");
//            return complemented;
//        } else if (!arrEq(changedArray, initialArray) && !arrEq(changedArray, complemented) && arrEq(changedArray, reversed) && !arrEq(changedArray, both)) {
