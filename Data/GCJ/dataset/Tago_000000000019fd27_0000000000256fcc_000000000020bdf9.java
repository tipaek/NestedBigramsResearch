            ...
            for(int j=0;j<n;j++)
            {
                if(!imp)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if((ActList[j][1] > cList.get(a)[0] && ActList[j][1] < cList.get(a)[1]) || (ActList[j][2] > cList.get(a)[0] && ActList[j][2] < cList.get(a)[1]) || (ActList[j][1] == cList.get(a)[0] && ActList[j][2] == cList.get(a)[1]))
                            {
                                flag = false;
                                break;
                            }
                    ...
                    else
                    {
                        ...
                        {
                            if((ActList[j][1] > jList.get(a)[0] && ActList[j][1] < jList.get(a)[1]) || (ActList[j][2] > jList.get(a)[0] && ActList[j][2] < jList.get(a)[1]) || (ActList[j][1] == jList.get(a)[0] && ActList[j][2] == jList.get(a)[1]))
                            {
                                flag = false;
                                break;
                            }
