...
public class Solution {
    ...
    static int gcd(int a, int b) {
        ...
        public static class Taskl{
            ...
            public Taskl(int start, int end) {
                this.start = start;
                this.end = end;
            }
        }
        public static int sortbyStart(Taskl t1,Taskl t2){
        if(t1.start != t2.start) return t1.start-t2.start;
        else return t1.end-t2.end;
        }
        public static boolean taskmerge(Taskl t1,Taskl t2){
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
           flag++;
           int n = r.nextInt();
           Taskl c = new Taskl(0,0);
           Taskl j = new Taskl(0,0);
           HashMap<Integer,Taskl> hm = new HashMap<>();
           for(int i=0;i<n;i++){
               int start = r.nextInt();
               int end = r.nextInt();
               hm.put(i+1,new Taskl(start,end));
           }
           int[] index = new int[n];
           for(int i=0;i<n;i++){
               index[i] = i+1;
