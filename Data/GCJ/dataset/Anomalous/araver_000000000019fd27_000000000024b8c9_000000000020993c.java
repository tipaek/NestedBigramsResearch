...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            int tests = Integer.parseInt(br.readLine()); // Number of test cases

            for (int i = 0; i < tests; i++) {
                int n = Integer.parseInt(br.readLine()); // Size of the matrix
                int latinSum = n * (n + 1) / 2; // Expected sum for a Latin square
