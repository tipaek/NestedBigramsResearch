    ...
    static {
        ...
        while (!queue.isEmpty()) {
            ...
            if (i < 0 || i >= SOLUTIONS.length || j < 0 || j >= SOLUTIONS[0].length) {
                if (pos.step > 2 * SOLUTIONS.length) {
                    continue;
                }
            } else {
            ...
            queue.add(new Position(pos.x + nextStep, pos.y, nextStep, pos.dirs + "E"));
            queue.add(new Position(pos.x - nextStep, pos.y, nextStep, pos.dirs + "W"));
            queue.add(new Position(pos.x, pos.y + nextStep, nextStep, pos.dirs + "N"));
            queue.add(new Position(pos.x, pos.y - nextStep, nextStep, pos.dirs + "S"));
        }
    }
