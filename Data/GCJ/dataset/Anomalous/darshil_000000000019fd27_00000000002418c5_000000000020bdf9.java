...
public class Solution {
    ...
    public static int compareByStart(Task t1, Task t2) {
        if (t1.start != t2.start) return t1.start - t2.start;
        return t1.end - t2.end;
    }

    public static boolean canMerge(Task t1, Task t2) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            Arrays.sort(indices, (a, b) -> compareByStart(tasks.get(a), tasks.get(b)));

            int count = 1;
            HashMap<Integer, Character> assignment = new HashMap<>();
            assignment.put(indices[0], 'C');
            ...
            if (count == n) {
                for (int i = 0; i < n; i++) {
                    System.out.print(assignment.get(i + 1));
                }
                System.out.println();
            } else {
