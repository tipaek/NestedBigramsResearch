...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int p = 1; p <= q; p++) {
            ...
            System.out.flush();
            int k = sc.nextInt();
            String s5 = (s.charAt(0) == (char) (k + '0')) ? s : s2;
            String s6 = (s1.charAt(0) == (char) (k + '0')) ? s1 : s3;
    ...
    public static Comparator<Pair> C() {
        return new Comparator<Pair>() {
            ...
            public int compare(Pair o1, Pair o2) {
                if (o2.a.compareTo(o1.a) == 0) return o2.in.compareTo(o1.in);
...
class SegmentTree {
    ...
    int getValueUtil(int root, int l, int r, int gl, int gr) {
        if (l >= gl && r <= gr) return s[root];
        if (l > gr || r < gl) return Integer.MAX_VALUE;
