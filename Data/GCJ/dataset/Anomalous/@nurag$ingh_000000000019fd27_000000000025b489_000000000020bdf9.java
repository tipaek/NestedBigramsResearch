...
public class Solution {
    public static void main(String[] args) {
        ...
        for (int rr = 0; rr < t; rr++) {
            ...
            Sarr[0] = S[0];
            Earr[0] = E[0];
            ans[0] = 10; // 'C' is represented by 10
            int k = 1;
            boolean flag = false;
            
            for (int i = 1; i < n; i++) {
                Set<Integer> assign = new HashSet<>(Arrays.asList(10, 11)); // 'C' is 10 and 'J' is 11
                ...
                Sarr[k] = S[i];
                Earr[k] = E[i];
                ans[k] = assign.iterator().next(); // Get the first available assignment
                k++;
            }
