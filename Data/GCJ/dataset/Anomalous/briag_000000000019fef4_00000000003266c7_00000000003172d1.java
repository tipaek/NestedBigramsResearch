...
public class Solution {
        ...
        for (int testCase = 1; testCase <= testCases; ++testCase) {
            ...
            for (int i = 0; i < numberOfSlices; i++) {
                ...
                for (int j = 0; j < numberOfSlices; j++) {
                    ...
                    parts[i][j].perfectCut = (sliceSize2 % sliceSize == 0);
                }
            }
    ...
    public static boolean isPossible(Data[] numberOfParts, long value) {
        for (Data part : numberOfParts) {
            value -= part.nbOfPart;
            if (value <= 0) {
                return true;
            }
    ...
    public static class Data implements Comparable<Data> {
        ...
        public int compareTo(Data other) {
            if (this.perfectCut && !other.perfectCut) {
                return -1;
            } else if (other.perfectCut && !this.perfectCut) {
                return 1;
            }

            return Long.compare(other.nbOfPart, this.nbOfPart);
        }
    }
}