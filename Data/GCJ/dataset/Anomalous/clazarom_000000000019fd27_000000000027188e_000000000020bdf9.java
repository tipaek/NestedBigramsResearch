...
public class Solution {
    ...
    public String computeSchedule(String[] activities, int numActivities, int scheduledDay) {
        ...
        Parent parent1 = new Parent(scheduledDay % 2 != 0 ? CAMERON : JAMIE, activities.length);
        Parent parent2 = new Parent(scheduledDay % 2 != 0 ? JAMIE : CAMERON, activities.length);
            ...
            for (int[] timeActivity : timeActivities) {
                ...
                if (timeActivity.length == 2) {
                    if (parent1.isAvailable(timeActivity)) {
                        ...
                        if (assignResult == Parent.UNAVAILABLE && parent2.isAvailable(timeActivity)) {
