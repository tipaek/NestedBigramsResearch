...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < inputList.size(); i++) {
            ...
            if (currentString.charAt(0) == '0' && areAllCharactersSame(currentString)) {
                outputList.add(i, currentString);
            } else {
                ...
                outputList.add(i, stringBuilder.toString());
            }
        }
    ...
    static boolean areAllCharactersSame(String s) {
