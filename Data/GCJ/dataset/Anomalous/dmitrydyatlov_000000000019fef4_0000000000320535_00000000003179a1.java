...
public class Solution {
    ...
    static class Pair {
        ...
        Pair(char character, long count) {
            this.character = character;
            this.count = count;
        }
    }

    private void execute(InputReader in, PrintWriter out) {
        int u = in.nextInt();
        ...
        PriorityQueue<Pair> priorityQueue = new PriorityQueue<>((o1, o2) -> Long.compare(o2.count, o1.count));
