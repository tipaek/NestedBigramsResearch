...
public class Solution {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; i++) {
            ...
            List<AbstractMap.SimpleEntry<Integer,AbstractMap.SimpleEntry<Integer,Integer>>> originalActivities = new ArrayList(activities);
    ...
    private static void print(List<AbstractMap.SimpleEntry<Integer,AbstractMap.SimpleEntry<Integer,Integer>>> s,
                              List<AbstractMap.SimpleEntry<Integer,AbstractMap.SimpleEntry<Integer,Integer>>> os){
