...
public class Solution {
	public static void main(String[] args){
		...
		for(int i=0; i<totalCase; i++) {
			...
			Map<Integer, Integer> firstOptionalSet= getNegativeSet(setCombination(getRemainder(first)), getMaxPower(first));
			
			Map<Integer, Integer> secondNumberSet = setCombination(second);
			Map<Integer, Integer> secondOptionalSet= getNegativeSet(setCombination(getRemainder(second)), getMaxPower(second));
	...
	private static Map<Integer, Integer> getNegativeSet(Map<Integer, Integer> map, int number){
