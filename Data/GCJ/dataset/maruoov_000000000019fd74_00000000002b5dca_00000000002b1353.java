...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        while(T > 0) {
            ...
            path[0][0] = 1;
            path[0][1] = 1;
            boolean[][] visit = new boolean[31][31];
            visit[0][0] = true;
            visit[0][1] = true;
    ...
    public static void find(int[][] map, int curX, int curY, int[][] path, int sum, int cnt,  int N, List<List<Integer>> res, boolean[][] visit) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (tx < 0 || ty < 0 || tx > 30 || ty > 30 || map[tx][ty] == 0 || visit[tx][ty]) continue;
