...
public class Solution {
    private static TreeMap<Float, Integer[]> timePeriod = new TreeMap<>();
    ...
    private static String assingedActivity(int numberOfActivity){
        ...
        for(Map.Entry<Float, Integer[]> entry : timePeriod.entrySet()) {
           startTimeList.add(entry.getKey().intValue());
