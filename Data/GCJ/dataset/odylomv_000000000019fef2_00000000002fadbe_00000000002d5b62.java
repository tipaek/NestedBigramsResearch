...
//        System.out.println(currY);
        String up = findBest(currX, currY.add(size), BigInteger.TWO.multiply(size), previous + "N");
        String down = findBest(currX, currY.subtract(size), BigInteger.TWO.multiply(size), previous + "S");
        String right = findBest(currX.add(size), currY, BigInteger.TWO.multiply(size), previous + "E");
        String left = findBest(currX.subtract(size), currY, BigInteger.TWO.multiply(size), previous + "W");
