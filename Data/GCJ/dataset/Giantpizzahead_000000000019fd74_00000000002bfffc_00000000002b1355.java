...
public class Solution {
    ...
    Queue<Cell> toEliminate, nextElims = new LinkedList<>();
    int[][] skill, neighborSum;

    Solution(BufferedReader in, PrintWriter out, int tn) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= T; i++) new Solution(in, out, i);
        in.close();
        out.close();
    }
}
