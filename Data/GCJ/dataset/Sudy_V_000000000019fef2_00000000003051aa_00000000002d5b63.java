...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i <= t; i++) {
            ...
            int b = in.nextInt();
            if (a == b && a == 999999995) {
                solve(in, a, b, -5, 5, count);
            }
        }
        out.close();
    }

    public static void solve(FastScanner input, int a, int b, int x, int y, int count) throws Exception {
        String s = input.next();
        ...
        if (s.equals("CENTER")) {
            ...
            if (count % 2 == 0) {
                solve(in, a, b, (x + 1), y, count + 1);
            } else {
                solve(in, a, b, x, y-1, count + 1);
            }
        }
    }
