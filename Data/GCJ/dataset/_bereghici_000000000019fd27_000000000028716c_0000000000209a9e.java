    ...
    public static void main(String[] args) {
        ...
        if (b == 10) {
            ...
            for (int i = 0; i < t; ++i) {
                ...
                String result = "";
                if (a0.equals(a3) && c0.equals(c3)) {
                    result = toString(a0) +
                            toString(b0) +
                            toString(c0) +
                            toString(d0);
                } else if (complementary(a3).equals(a0) && complementary(c3).equals(c0)) {
                    result = toString(complementary(a0)) +
                            toString(complementary(b0)) +
                            toString(complementary(c0)) +
                            toString(complementary(d0));
                } else if (reversed(c3).equals(b0) && reversed(a3).equals(d0)) {
                    result = toString(reversed(d0)) +
                            toString(reversed(c0)) +
                            toString(reversed(b0)) +
                            toString(reversed(a0));
                } else if (reversed(complementary(c3)).equals(b0) && reversed(complementary(a3)).equals(d0)) {
                    result = toString(reversed(complementary(d0))) +
                            toString(reversed(complementary(c0))) +
                            toString(complementary(complementary(b0))) +
                            toString(complementary(complementary(a0)));
                }
