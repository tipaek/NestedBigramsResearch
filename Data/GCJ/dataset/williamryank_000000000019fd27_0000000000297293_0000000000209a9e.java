        ...
        for (int ks = 1; ks <= T; ks++) {
            ...
            for (int counter = 1; counter <= 150; counter++) {
                ...
                if (counter % 10 == 1 && counter > 1) {
                    int prevDiff = result[idxDiff];
                    int prevSame = result[idxSame];
                    ...
                    if (idxDiff != 0 && idxSame != 0) {
                        ...
                        if (prevDiff != result[idxDiff] && prevSame != result[idxSame]) {
                        ...
                        } else if (prevDiff != result[idxDiff]) {
                            for (int p = 1; p <= currTemp; p++) {
                                if (swaps[p] == 0) {
                                    swaps[p]++;
                                } else {
                        ...
                        } else if (prevSame != result[idxSame]) {
                            for (int p = 1; p <= currTemp; p++) {
                                if (swaps[p] == 0) {
                                    swaps[p]++;
                                } else {
                    ...
                    result[idxSame] = prevSame;
                    result[idxDiff] = prevDiff;
                    continue;
                }
