        ...
        for (int i = 1; i <= t; ++i) {
            ...
            for(int j = 0; j < splitted.length; j++) {
                if(splitted[j].length() > 0) {
                    ...
                    solution += (new String(new char[openedBrackets]).replace("\0", ")"));
