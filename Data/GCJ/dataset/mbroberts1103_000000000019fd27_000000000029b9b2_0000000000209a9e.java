...
public class Solution {
  ...
  public static int query(int ind) {
    ...
    // System.err.printf("flip: %s rev: %s -- guess: %s count: %s, ind: %d\n",
    // anchorFlip, anchorReverse, guessComp,
    // guessCount, ind);
  ...
  public static void handleQuantumFluctuations() {
    ...
    if (anchorFlip > 0) {
      ...
      // naively waste a turn to keep count even, prevents flip ind headaches
      System.out.println(1);
      guessCount++;
      sc.nextLine().trim().charAt(0);
    }
