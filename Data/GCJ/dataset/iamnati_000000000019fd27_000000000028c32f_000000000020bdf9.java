...
public class Solution {
	public static String validSchedule(int[][] activitySchdules) {
		...
		String result = solution ?  getStringVersion(schedule, activityOrderMap) : "IMPOSSIBLE";
		return result;
	}
	...
	private static String getStringVersion(Stack<Activity> activities, Map<Activity, Integer> orderMap) {
		...
		while (scheduleIterator.hasNext()) {
			...
			activityAssignment[orderMap.get(next)] = next.assignedParent();
		}
