...
public class Solution{
    public static void main(String[] args){
        ...
        for(int testcase = 1; testcase<=T; testcase++){
            ...
            int my = 0;
            while(!hitt){
                int giskx = (int) (2*Math.pow(10,9)*Math.random()-Math.pow(10,9));
                int gisky = (int) (2*Math.pow(10,9)*Math.random()-Math.pow(10,9));
