...
public final class Solution {
    ...
    private static void solveCase(Scanner r, PrintWriter w, int a, int b) {
        ...
        while (true) {
            ...
            //shimmy
            if (test(r, w, new Coords(center.x + 1, center.y)) == Result.CENTER) return;
            if (test(r, w, new Coords(center.x - 1, center.y)) == Result.CENTER) return;
            ...
            CoordResult edgeA = binarySearch(r, w, caStart, ca, center);
            if (edgeA.result == Result.CENTER) return;
            CoordResult edgeB = binarySearch(r, w, cbStart, cb, center);
            if (edgeB.result == Result.CENTER) return;
            CoordResult edgeD = binarySearch(r, w, cdStart, cd, center);
    ...
    private static CoordResult binarySearch(Scanner r, PrintWriter w, Coords from, Coords to, Coords fromFallBack) {
