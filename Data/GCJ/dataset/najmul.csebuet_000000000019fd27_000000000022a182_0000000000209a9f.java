...
public class Solution {
    ...
    public void solution(int caseNumber, String s) {
        ...
        StringBuilder sPrimeFinal = new StringBuilder();
        ...
        for (int i = 0; i < sPrimeString.length() - 1; i++) {
            ...
            sPrimeFinal.append(sPrimeString.charAt(i));
        }

        sPrimeFinal.append(sPrimeString.charAt(sPrimeString.length() - 1));

        out.println("Case #" + caseNumber + ": " + sPrimeFinal.toString());
