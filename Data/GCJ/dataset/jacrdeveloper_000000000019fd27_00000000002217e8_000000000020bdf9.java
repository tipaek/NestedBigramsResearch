...
public class Solution {
	...
	private static final String JAIME = "J";
	private static final String IMPOSIBLE = "IMPOSSIBLE";
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= t; ++i) {
			...
			mapActividades.put(CAMERON, new ArrayList<Integer>());
			mapActividades.put(JAIME, new ArrayList<Integer>());
			...
			for (int o = 0; o < n; o++) {
				...
				if (!asignado) {
					resultCase = new StringBuffer().append(IMPOSIBLE);
				}
			}
