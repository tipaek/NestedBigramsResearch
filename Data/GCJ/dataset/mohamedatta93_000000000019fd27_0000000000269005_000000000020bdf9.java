...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= t; ++i) {
			...
			int n = in.nextInt();
			List<Activity> activities = new ArrayList<problem3.Activity>();
			for (int j = 0; j < n; j++) {
				activities.add(problem3.new Activity(in.nextInt(), in.nextInt()));
			}
			List<Activity> JActivities = new ArrayList<problem3.Activity>();
			List<Activity> CActivities = new ArrayList<problem3.Activity>();
			String solution = "";
