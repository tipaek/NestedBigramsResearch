...
public class Solution {
    ...
    public static int[][] jMem = null;
    public static int[][] cMem = null;
    ...
    public static String prepareSchedule(int[][] schedule){
        ...
        jMem = new int[schedule.length][1441];
        cMem = new int[schedule.length][1441];
    ...
    public static String makeSchedule(int[][] schedule, int position, int Cameron, int Jam, String plannedAlready) {
        ...
        if (jMem[position][Cameron] > 0 && jMem[position][Cameron] <= Jam
                || jMem[position][Jam] > 0 && jMem[position][Jam] <= Cameron){
            return "";
        }
        if (jMem[position][Cameron] == 0 || jMem[position][Cameron] > Jam){
            jMem[position][Cameron] = Jam;
        }
        if (jMem[position][Jam] == 0 || jMem[position][Jam] > Cameron){
            jMem[position][Jam] = Cameron;
        }
