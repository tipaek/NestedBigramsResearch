    ...
    public static String rec(int x, int y, int curr_x,int curr_y,int curr_in,String res,int[] arr){
        if(x==curr_x&&y==curr_y){
         //   System.out.println(res);
          return res;
        }else if(Math.abs(Math.abs(curr_x)-Math.abs(x))>1000000||Math.abs(Math.abs(curr_y)-Math.abs(y))>1000000){
            return "PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP";
