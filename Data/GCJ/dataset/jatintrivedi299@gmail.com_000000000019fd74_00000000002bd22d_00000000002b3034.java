...
public class Solution_PatternMatching {
    ...
    public void getAnswer(int caseNum, Scanner scanner) {
        ...
        for (int i = 0 ; i < list.size() ; i++) {
            ...
            char[] preC = prevLeft.toCharArray();
            char[] curC = curLeft.toCharArray();

//            char[] preC = prev.toCharArray();
//            char[] curC = str.toCharArray();
            int n1 = preC.length , n2 = curC.length;
            int i1 = 0 , i2 = 0;
            ...
            // test case 1 & 2 after *
            preC = prevRight.toCharArray();
            curC = curRight.toCharArray();
            n1 = preC.length ;
            n2 = curC.length;
        ...
        String res = "*";
        if (pattern) {
            res = prevLeft + prevRight ;
        }

        System.out.println(String.format(output1, caseNum, res));
    }
