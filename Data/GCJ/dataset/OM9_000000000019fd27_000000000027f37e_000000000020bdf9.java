...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int test = 1; test <= testCases; test++) {
            ...
            List<Integer> cTrackor = new ArrayList<>();
            cTrackor.add(0);
            List<Integer> jTrackor = new ArrayList<>();
            jTrackor.add(1);
            for (int i = 2; i < n; i++) {
                if(assignTracker(activities, cTrackor, i)){
                    activities.get(i).setPerson('C');
                    cTrackor.add(i);
                }else if(assignTracker(activities, jTrackor, i)){
