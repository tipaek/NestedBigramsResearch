...
public class Solution {
    public static class Range {
        ...
        public boolean isOverlap(Range input) {
            if (input.start >= start && input.start < end) {
                return true;
            }
            if (input.end <= end && input.end > start) {
                return true;
            }
            if (input.start <= start && input.end >= end) {
                return true;
            }
            return false;
        }
