...
public class Solution {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            final Set<String> possibleNotZero = new HashSet<>();
            boolean case3 = false;
            for (int j = 0; j < 10_000; j++) {
                ...
                if (qi == -1) {
                    ...
                    if (ri.length() != 1) {
                        possibleNotZero.add(ri.toCharArray()[0] + "");
                    }
            ...
            if (case3) {
                HashSet<String> newAll = new HashSet<>(all);
                newAll.removeAll(possibleNotZero);
                System.out.println("Case #" + i + ": " + newAll.stream().collect(Collectors.joining()) + possibleNotZero.stream().collect(Collectors.joining()));
                continue;
            }
