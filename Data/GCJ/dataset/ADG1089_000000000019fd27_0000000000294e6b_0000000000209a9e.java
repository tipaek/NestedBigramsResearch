...
public class Solution {
    ...
    private static Queue<Integer> reverse(List<Integer> arr, Queue<Integer> unsolved) {
        reverse2(arr);
        Queue<Integer> unsolved2 = new LinkedList<>();
        while (unsolved.size() > 0) {
            unsolved2.add(b - unsolved.poll() + 1);
        }
        return unsolved2;
    }
