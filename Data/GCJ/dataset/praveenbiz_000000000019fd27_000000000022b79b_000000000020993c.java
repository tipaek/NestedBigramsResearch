...
public class Vest {
	...
	public static void main(String args[]) {
		...
		for (int c = 1; c <= count; c++) {
			...
			try {
				if (Vest.latinSquare(matrix)) {
					System.out.println("This is a Latin Square");
					sumOfMainDiagnal = Vest.sumOfMainDiagnal(matrix);
					repRowsCount = Vest.repeatedRowsCount(matrix);
					repColsCount = Vest.repeatedColsCount(matrix);
