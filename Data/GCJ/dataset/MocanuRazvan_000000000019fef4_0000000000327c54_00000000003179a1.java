...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int i=0;i<nr;i++) {
			...
			for (int j=0;j<10000;j++) {
				if(q[j]>=10&&q[j]<=19&&r[j].length()>1)letters[1]=r[j].charAt(0);	
			}
			...
			for (int j=0;j<10000;j++) {
				if(q[j]>=30&&q[j]<=39&&r[j].charAt(0)!=letters[1]&&r[j].charAt(0)!=letters[2]&&r[j].length()>1)letters[3]=r[j].charAt(0);	
			}
			...
			for (int j=0;j<10000;j++) {
				if(q[j]>=40&&q[j]<=49&&r[j].charAt(0)!=letters[1]&&r[j].charAt(0)!=letters[2]&&r[j].charAt(0)!=letters[3]&&r[j].length()>1)letters[4]=r[j].charAt(0);	
			}
