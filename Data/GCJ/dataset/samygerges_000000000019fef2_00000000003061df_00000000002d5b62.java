			...
			else
			{
				if (i - 1 >= 0)
				{
					if (moves[i - 1] == 'S' && !invy)
					{
						...
						if (i + 1 < arry.length && arry[i + 1] == 0 && arrx[i + 1] == 0)
						{
							arry[i + 1] = 1;
						}
						else
					...
					else if (moves[i - 1] == 'E' && !invx)
					{
						...
						if (i + 1 < arrx.length && arrx[i + 1] == 0 && arry[i + 1] == 0)
						{
							arrx[i + 1] = 1;
						}
						else
