...
public class Solution {
	public static void main(String[] args) {
		...
		while(t>0) {
			...
			int i=0;
			if(l!=r) {
				i= binarySearch(0,Integer.MAX_VALUE-3,(long) Math.abs(r-l));
			}
...
//						System.out.println(l + " " + r);
			...
			int a = binarySearchl(1,Integer.MAX_VALUE-3,i,Math.max(l,r));
			int b = binarySearchr(1,Integer.MAX_VALUE-3,i,Math.min(l,r));
