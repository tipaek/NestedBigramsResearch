...
public class Solution {
    ...
    static String joinSuffixes(StringSegments[] sgs) {
        ...
        for (StringSegments sg : sgs) {
            if (sg.suffix == null) hasNulls = true;
            else hasNonNulls = true;
        }
        if (hasNulls && hasNonNulls) return null;
    ...
    public static void main(String[] params) {
        ...
        for (int i = 0; i < t; ++i) {
            ...
            System.out.println(String.format("Case #%d: %s", i + 1, solution == null ? "*" : solution));
        }
    }
}
