...
public class Solution {
	...
	public static void main(String[] args) {
		...
		while(c<=t) {
			...
			ArrayList<Activity> input = new ArrayList<Solution.Activity>(act);
			ArrayList<Activity> jAct = new ArrayList<Solution.Activity>(act);
			ArrayList<Activity> cAct = new ArrayList<Solution.Activity>(act);
			for(int i=0;i<act;++i) {
