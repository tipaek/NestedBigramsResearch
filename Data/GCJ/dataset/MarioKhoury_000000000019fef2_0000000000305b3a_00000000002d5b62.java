...
class Solution{
    ...
    public static boolean isTrue(String Sum){
    ...
    public static void main(String[] args){
        ...
        for(int i =1;i<=t;i++){
            ...
            String Xb = binary(X);
            String Yb = binary(Y);
            String binaryX = binary(nextPowerOf2(X));
            String binaryY = binary(nextPowerOf2(Y));
                        ...
                        if(X >=0&&Y>=0){
                            if(S.length()>Yb.length()){
                                for(int j =S.length()-1;j>= 0;j--){
                                    if(S.charAt(j) == '1'){
                                        if(binaryX.length() > j &&binaryX.charAt(j) == '1'){
                                            res+= 'E';
                                        }else{
                                            res+='W';
                                        }
                                ...
                                for(int j =Yb.length()-1;j>= 0;j--){
                                    if(Yb.charAt(j) == '1'){
                                        res+= 'N';
                                    }else if(binaryX.length() > j &&binaryX.charAt(j) == '1'){
                                        res +='E';
                                    }else{
                                        res+='W';
                                    }
                        ...
                        if(Xb.length()>R.length()){
                            for(int j =Xb.length()-1;j>= 0;j--){
                                if(Xb.charAt(j) == '1'){
                                    ...
                                    if(binaryY.length() > j && binaryY.charAt(j) == '1'){
                                        res +='N';
                                    }else{
                                        res +='S';
                                    }
