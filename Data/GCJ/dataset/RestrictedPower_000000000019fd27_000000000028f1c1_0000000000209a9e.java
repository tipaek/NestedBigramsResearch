...
/*
    Solution Created: 23:37:18 04/04/2020
	...
	static void solveCase(Reader in, Writer out, int n) {
		...
		while(true) {
			if(i%10!=1||i==1) {
				...
				a[l] = A[0];
				a[n-l-1] = A[1];
				if(A[0]==0&&A[1]==0) t[1] = l;
				else if(A[0]==1&&A[1]==1) t[0] = l;
				else if(A[0]==1&&A[1]==0) t[3] = l;
				else if(A[0]==0&&A[1]==1) t[2] = l;
				l++;
				i+=2;
				if(l>=n-l-1) break;
			}else {
		...
		out.println();
		out.flush();
		if(in.next().equalsIgnoreCase("N")) System.exit(0);
	}
