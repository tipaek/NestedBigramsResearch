...
//        Map<Ratio, Set<Integer>> map = new HashMap<>();
        Map<Ratio, Set<Integer>> map = new TreeMap<>();
//        Map<Ray, Set<Integer>> map = new HashMap<>();
        for (int i = 0; i < a.length; i++) {
...
//        out.println();
    ...
    public static class Ray implements Comparable<Ray> {
        // dy/dx
        public long dy;
        public long dx;

        public static final Ray ONE = new Ray(1, 1);
        public static final Ray ZERO = new Ray(0, 1);
        public static Comparator<Ray> angleComparator = new Comparator<Ray>() {
            @Override
        ...
        public Ray(long p, long q) {
            long g = gcd(Math.abs(p), Math.abs(q));
            if (g == 0) {
                this.dy = Long.signum(p);
                this.dx= Long.signum(q);
            } else {
                this.dy = p / g;
                this.dx = q / g;
            }
        ...
        public Ray inv() {
            return new Ray(dx,dy);
        }

        // negative, return -this
        public Ray neg() {
            return new Ray(-dy, dx);
        }
        
        // TODO handle overflow
        // return this+o
        public Ray add(Ray o) {
            long g=gcd( dx, o.dx);
            return new Ray(o.dx/g*dy + dx/g*o.dy, dx*o.dx/g);
        }

        // return this-o
        public Ray sub(Ray o) {
            long g=gcd( dx, o.dx);
            return new Ray(o.dx/g*dy - dx/g*o.dy, dx*o.dx/g);
//            return add(o.neg());
        }
        ...
        // return this*o
        public Ray mul(Ray o) {
            long g1=gcd( dy, o.dx);
            long g2=gcd( dx, o.dy);
            return new Ray(dy/g1 * (o.dy/g2), dx/g2 * (o.dx/g1));
        }
        ...
        public boolean equals(Object obj) {
            Ray r = (Ray) obj;
            return dy == r.dy && dx == r.dx;
        }

        @Override
        public int hashCode() {
            int result = 31 + (int) (dy ^ (dy >>> 32));
        ...
        public int compareTo(Ray o) {
            if (dy==o.dy) {                    
                return (this.dx < o.dx ? -1 : (this.dx == o.dx ? 0 : 1));
            }
            return dy<o.dy?-1:1;
        }
