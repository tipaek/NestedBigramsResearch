	...
	public String solve(int B, Scanner in) {
		if(B == 10) {
			...
			for(int i = 0; i < 12; i++) {
				...
				if(target2 != 0 && get2.charAt(0) != ans[target2-1]) {
					complement = true;
				}
				if(target1 != 0 && get1.charAt(0) != ans[target1-1]) reverse = !complement;
				else reverse = complement;
				
				if(MIRROR) {
					complement = false;
					if(target1 != 0 && get1.charAt(0) != ans[target1-1]) complement = true;
					if(target2 != 0 && get2.charAt(0) != ans[target2-1]) complement = true;
				}
