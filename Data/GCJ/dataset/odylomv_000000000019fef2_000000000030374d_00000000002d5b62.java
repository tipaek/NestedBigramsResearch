...
//            return "IMPOSSIBLE";
        PriorityQueue<Position> queue = new PriorityQueue<>(new PosComparator());
    ...
    public static class Position {
        ...
        public Position[] getAllMoves() {
            ...
            if (step.compareTo(Solution.x.abs().max(Solution.y.abs()).multiply(BigInteger.valueOf(2))) > 0)
                return new Position[]{};
        ...
        public BigInteger getDistance() {
            return Solution.x.abs().subtract(this.x.abs()).add(Solution.y.abs().subtract(this.y.abs()));
        }
    ...
    public static class PosComparator implements Comparator<Position> {
