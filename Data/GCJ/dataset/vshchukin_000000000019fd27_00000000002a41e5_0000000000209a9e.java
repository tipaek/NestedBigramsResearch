...
public class Solution {
    ...
    static class ESAbATAd {
        public void solve(int testNumber, Scanner in, PrintWriter out) {
            ...
            for (int _i = 0; _i < numTests; _i++) {
                for (int i = 0; i < numPairs; i++) {
                    ...
                    list.add(new ESAbATAd.EntangledBits(first, last));
                }
        ...
        private ESAbATAd.EntangledBits merge(List<ESAbATAd.EntangledBits> toMerge) {
            ...
            return new ESAbATAd.EntangledBits(first, last);
        }
        ...
        static class EntangledBits {
            ...
            public EntangledBits(BitSet first, BitSet last) {
                this.first = first;
                this.last = last;
            ...
            public void writeOutput(PrintWriter out, Scanner in) {
                ...
                if (!res.equals("Y")) {
                    throw new NullPointerException("Failed test! Got result from judge: " + res);
                }
            }
