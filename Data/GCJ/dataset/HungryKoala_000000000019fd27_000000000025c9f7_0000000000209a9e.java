    ...
    private static enum Op {
        Id {
            ...
            public boolean matches(final char[] b, final char[] p) {
                if (b[1] != p[1] || b[2] != p[2] || b[3] != p[3] || b[4] != p[4] ||
                        b[17] != p[17] || b[18] != p[18] || b[19] != p[19] || b[20] != p[20]) {
                    return false;
                }
                return true;
            }
        ...
        Comp {
            @Override
            public boolean matches(final char[] b, final char[] p) {
                if (b[1] != flip(p[1]) || b[2] != flip(p[2]) || b[3] != flip(p[3]) || b[4] != flip(p[4]) ||
                        b[17] != flip(p[17]) || b[18] != flip(p[18]) || b[19] != flip(p[19]) || b[20] != flip(p[20])) {
                    return false;
                }
                return true;
            }
        ...
        Rev {
            @Override
            public boolean matches(final char[] b, final char[] p) {
                if (b[1] != p[20] || b[2] != p[19] || b[3] != p[18] || b[4] != p[17] ||
                        b[17] != p[4] || b[18] != p[3] || b[19] != p[2] || b[20] != p[1]) {
                    return false;
                }
                return true;
            }
        ...
        RevComp {
            @Override
            public boolean matches(final char[] b, final char[] p) {
                if (b[1] != flip(p[20]) || b[2] != flip(p[19]) || b[3] != flip(p[18]) || b[4] != flip(p[17]) ||
                        b[17] != flip(p[4]) || b[18] != flip(p[3]) || b[19] != flip(p[2]) || b[20] != flip(p[1])) {
                    return false;
                }
                return true;
            }
