...
public class Solution {
    ...
    public void solve() {
        ...
        for (int i = 1; i <= t; i++) {
            ...
            int nextPowerOf2 = nextPower(sum);
            long curr = (long) Math.pow(2.0, nextPowerOf2);
    ...
    private int nextPower(long sum) {
        int x = 0;
        while (sum > 0) {
            x++;
            sum = sum / 2;
    ...
    private boolean dfs(long xi, long yi, long x, long y, int i, long totalSum) {
        ...
        if ( i != 0 || x % 2 != 0 || Math.abs(x-xi)+Math.abs(y-yi)<=totalSum) {
            sb.append("E");
        ...
        if ( i != 0 || y % 2 != 0 || Math.abs(x-xi)+Math.abs(y-yi)<=totalSum ) {
            sb.append("S");
