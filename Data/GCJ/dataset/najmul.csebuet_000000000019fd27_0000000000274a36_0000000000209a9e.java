...
public class Solution {
    ...
    private void solve100(int testCaseNumber, int B, Scanner sc) {
    ...
    public void solve20(int testCaseNumber, int B, Scanner sc) {
        ...
        Segment four3 = computeFour3(one2, three2, four2, one3, two3);
    ...
    private Segment computeFour3(Segment one2, Segment three2, Segment four2, Segment one3, Segment two3) {
