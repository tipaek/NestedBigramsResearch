	...
	void solve() throws Exception
	{
		...
		for(int ca=1;ca<=t;ca++)
		{
			...
			for(int i=0;i<s.length();i++)
			{
				...
				{
					answer=answer+(openPar(Integer.parseInt(s.charAt(i)+"")-curr));
					answer=answer+s.charAt(i);
					
					curr=Integer.parseInt(s.charAt(i)+"");
				}
				else
				{
					
					answer=answer+closePar(curr-Integer.parseInt(s.charAt(i)+""));
					answer=answer+s.charAt(i);
