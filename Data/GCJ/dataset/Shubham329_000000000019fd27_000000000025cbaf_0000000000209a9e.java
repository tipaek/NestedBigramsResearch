...
public class Solution {
    ...
    private static void check(int[][] diff, int[] arr) {
    ...
    private static void checkAndPerform(int[][] diff, int[] arr, List<Integer> values) {
    ...
    private static List<Integer> getValues(List<Integer> index, Scanner sc) {
    ...
    private static void addNext(List<Integer> list, int s, int e, int len) {
        for (int i = s; i < s + e; i++) {
            list.add(i);
            list.add(len - 1 - i);
        }
