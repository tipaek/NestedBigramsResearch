...
public class Solution {
    ...
    static String _s(Scanner sc) {
        ...
        int n = sc.nextInt();
        LinkedHashSet<Integer> freePeriods = new LinkedHashSet();
    ...
    static void distributeIntervals(char person, LinkedHashSet<Integer> freePeriods, MyInterval periods[], char result[], int lastStart) {
        int starts = 1441;
        int ends = 0;
        int period = 0;
