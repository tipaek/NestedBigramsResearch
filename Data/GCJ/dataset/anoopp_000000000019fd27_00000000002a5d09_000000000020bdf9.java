...
public class Solution {
	public static void main(String args[]) {
		...
		for (int i = 1; i <= t; ++i) {
			...
			for (int j = 0; j < a; j++) {
				...
				if(canBeAssigned(map1J, ss1, ee1)) {
					map1J.put(ss1, ee1);
					res.append("J");
				} else if(canBeAssigned(map2C, ss1, ee1)) {
					map2C.put(ss1, ee1);
					res.append("C");
				} else {
	...
	private static boolean canBeAssigned(TreeMap<Integer, Integer> map1, int ss1, int ee1) {
