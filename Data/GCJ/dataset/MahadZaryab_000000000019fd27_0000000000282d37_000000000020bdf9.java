...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int test = 1; test <= numTests; test++) {
            ...
            System.out.printf("Case #%s: %s", test, tempResult);
            System.out.println();
        }

//        int [] startTimes = new int[]{1,2,99,100,150};
//        int[] endTimes = new int[]{100,5,150,301,250};
//        System.out.println(getSchedule(startTimes, endTimes));
    }
