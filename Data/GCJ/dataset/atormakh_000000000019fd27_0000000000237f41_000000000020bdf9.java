...
public class Solution {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= testSetSize; ++i) {
            ...
            ArrayList<Integer> cameronStarting = new ArrayList();
            ArrayList<Integer> cameronEnding = new ArrayList();
            ArrayList<Integer> jamieStarting = new ArrayList();
            ArrayList<Integer> jamieEnding = new ArrayList();
    ...
    private static int tryGiveActivity(int startingTime, int endingTime, ArrayList<Integer> startingArray, ArrayList<Integer> endingArray){
        ...
        for(int i=0;i< startingArray.size() && !doestFit;i++){
            ...
            fourth = (startingTime <= endingTimeI && endingTime >= startingTimeI );
            fifth = (startingTime > startingTimeI && endingTime < endingTimeI);
            sixth = (startingTime == startingTimeI || endingTime == endingTimeI);
            //if(fourth){
