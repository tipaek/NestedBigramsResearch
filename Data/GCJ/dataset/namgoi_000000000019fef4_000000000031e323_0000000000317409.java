	...
	public static void main(String[] args) throws Exception{
		...
		for (int testcase = 1; testcase <=T; testcase++) {
			...
			while(!q.isEmpty()) {
				...
				if(cur[0]!=1000 && cur[0]<dest[cur[2]][0]+1 && map[cur[0]+1+1500][cur[1]+1500]==0) {
				...
				if(cur[1]!=1000 && cur[1]<dest[cur[2]][1]+1 && map[cur[0]+1500][cur[1]+1+1500]==0) {
				...
				if(Math.abs(cur[1]-dest[cur[2]][1])+Math.abs(cur[1]-dest[cur[2]][1])<3 && map[cur[0]+1500][cur[1]+1500]==0) {
