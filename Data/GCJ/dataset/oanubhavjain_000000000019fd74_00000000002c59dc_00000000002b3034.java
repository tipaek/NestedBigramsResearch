...
//            Arrays.stream(sarr).forEach(System.out::println);
        ...
        String res1 = lastAsterik(lastVMap,true);
        if(!res1.equals("*")){
            String res2 = lastAsterik(firstVMap,false);
    ...
    public static String lastAsterik(LinkedHashMap<String,Integer> map,boolean isLast){
