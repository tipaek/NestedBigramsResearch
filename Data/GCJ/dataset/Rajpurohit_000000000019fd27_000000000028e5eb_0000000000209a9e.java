...
public class Solution {
    ...
    private static final InterativeSystem interactiveSystem = new DefaultInteractiveSystem();
    ...
    private static void interact(int[] ar) throws IOException {
        ...
        while (points < n) {
            ...
            if (iv == cpv) {
                if (iv == 0) zeroValueIndices.add(index + 1);
                else oneValueIndices.add(index + 1);
            } else {
