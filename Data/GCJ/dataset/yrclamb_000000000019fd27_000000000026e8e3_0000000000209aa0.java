...
public class Solution {
	...
	public static void mainX(String[] args) {
		...
		System.out.println(Q.solve(3,4));
		System.out.println(Q.solve(3,5));
		System.out.println(Q.solve(3,6));
		System.out.println(Q.solve(3,7));
		System.out.println(Q.solve(3,8));
		System.out.println(Q.solve(3,9));
		
		for(int i = 4; i <= 16; i++) {
			System.out.println(Q.solve(4,i));
		}
		
		for(int i = 5; i <= 25; i++) {
			System.out.println(Q.solve(5,i));
		}
		
		for(int i = 50; i <= 2500; i++) {
			System.out.println(Q.solve(50,i));
		}
	}
