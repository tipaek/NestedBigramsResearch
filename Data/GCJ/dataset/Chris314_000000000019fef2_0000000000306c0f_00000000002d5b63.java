...
public class Solution {
  public static void solve(Scanner input, int A, int B, int upperLeft[], int bottomRight[], int size) {
     ...
     if (s.equals("HIT")) {
         solve(input, A, B, upperLeft, new int[]{  upperLeft[0] + ((size)*5/6 + 1), upperLeft[0] - ((size)*5/6 + 1)}, ((size)*5/6 + 1));
         return;
     }
     ...
     if (s.equals("HIT")) {
         solve(input, A, B, new int[]{upperLeft[0], bottomRight[0] + ((size)*5/6 + 1)}, new int[] {upperLeft[0] + ((size)*5/6 + 1),bottomRight[1]}          ,((size)*5/6 + 1));
         return;
     }
