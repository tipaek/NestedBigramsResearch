...
class Solution
{
    public static void main(String[] args)throws IOException
    {
        ...
        for (int testCase = 1;testCase <= t;testCase++)
        {
            ...
            for (int i=0;i<n - 2;i++)
            {
                boolean f1 = checkIntersection(A[i].s, A[i].e, A[i + 1].s, A[i + 1].e);
                boolean f2 = checkIntersection(A[i + 1].s, A[i + 1].e, A[i + 2].s, A[i + 2].e);
                boolean f3 = checkIntersection(A[i].s, A[i].e, A[i + 2].s, A[i + 2].e);
                if (f1 && f2 && f3)
                {
                    flag = false;
                    break;
