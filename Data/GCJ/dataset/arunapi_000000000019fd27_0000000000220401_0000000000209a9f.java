        ...
        for (int i = 1; i <= t; ++i) { //each test case
            ...
            while(currentNode !=null){
                if(currentNode.prevNode!=null && currentNode.value!=0) {
                    if (currentNode.prevNode.openParanthesis > currentNode.closingParanthesis) {
                        currentNode.prevNode.closingParanthesis = (currentNode.prevNode.openParanthesis - currentNode.closingParanthesis);
                        currentNode.openParanthesis = 0;

                    }
                    else if (currentNode.prevNode.openParanthesis < currentNode.closingParanthesis) {
                        currentNode.openParanthesis = (currentNode.closingParanthesis - currentNode.prevNode.openParanthesis);
