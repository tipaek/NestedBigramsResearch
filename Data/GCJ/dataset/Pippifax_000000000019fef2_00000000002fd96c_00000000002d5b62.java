...
public class Solution {
    ...
    private static void computeScore(Point point, int testcaseId) {
        ...
        verifySolution(verticalJumps, horizontalJumps, point);
    }

    private static void verifySolution(int[] verticalJumps, int[] horizontalJumps, Point point) {
        ...
        for (int i = 0; i < 32; i++) {
            ...
            xScore += verticalJumps[i] * Math.pow(2, i);
            yScore += horizontalJumps[i] * Math.pow(2, i);
        }
