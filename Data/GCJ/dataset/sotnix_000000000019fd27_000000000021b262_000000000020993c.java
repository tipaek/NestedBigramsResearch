...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while( testCases > 0)
        {
            ...
            readArray(br, matrixSize);

            testCases--;
        }
    }

    private static void readArray(BufferedReader br, int matrixSize) throws IOException
    {
        int trace = 0;
        ...
        System.out.println(trace + " " + wrongRowCount + " " + wrongColCount);
    }
}
