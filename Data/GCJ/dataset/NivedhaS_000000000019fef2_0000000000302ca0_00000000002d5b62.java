...
public class Solution {
    ...
    private static String getQuadrant4(int x, int y, int sum, int nearest) {
        ...
        char[] dir = new char[2];
        if(nearest == sum) {
            ans = getWithoutCorrection(Math.abs(x), Math.abs(y), 'S', 'W', 0);
        }
        else{
            ...
            ans.append(getWithoutCorrection(Math.abs(x), Math.abs(y) + (difference / 2), 'S', 'W', power));
        }
        return ans.toString();
    }
    ...
    private static String getQuadrant3(int x, int y,int sum, int nearest) {
        ...
        char[] dir = new char[2];
        if(nearest == sum) {
            ans = getWithoutCorrection(Math.abs(x), Math.abs(y), 'S', 'E',0 );
        }
        else{
            int difference = (nearest - sum);
            int correction = difference / 2 ;
            ...
            ans.append(getWithoutCorrection(Math.abs(x), Math.abs(y) + (difference / 2), 'S', 'E', power));
        }
        return ans.toString();
    }
    ...
    private static String getQuadrant2(int x, int y, int sum, int nearest) {
        ...
        char[] dir = new char[2];
        if(nearest == sum){
            ans = getWithoutCorrection(Math.abs(x), Math.abs(y), 'N', 'E', 0);
        }
        else{
            int difference = (nearest - sum);
            int correction = difference / 2 ;
            ...
            ans.append(getWithoutCorrection(Math.abs(x), Math.abs(y) + (difference / 2), 'N', 'E', power));
        }
        return ans.toString();
    }
    ...
    private static String getQuadrant1(int x, int y, int sum,  int nearest) {
        ...
        char[] dir = new char[2];
        if(nearest == sum) {
            ans = getWithoutCorrection(Math.abs(x), Math.abs(y), 'N', 'W', 0);
        }
        else{
            int difference = (nearest - sum);
            int correction = difference / 2 ;
            ...
            ans.append(getWithoutCorrection(Math.abs(x), Math.abs(y) + (difference / 2), 'N', 'W', power));
        }
        return ans.toString();
    }
