...
public class Solution {
	...
	public String resolve (String [] input) {
		...
		//might overlap
		for (int overlap = 0; overlap <= endString.length(); overlap++) {
			String temp = this.workString + endString.substring(endString.length()-overlap);
			if (temp.endsWith(endString)) return temp;
		}
