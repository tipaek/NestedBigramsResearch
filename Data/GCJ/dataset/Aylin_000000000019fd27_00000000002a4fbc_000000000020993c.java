/* First input is the number of test case.
   Second diagonals of the matrix 

   for ( number of case )
        ---> diagonal numbers 
        --> #matrix (getting matrix input method)
        ---> new diagonal nums
    
    find the Latin square (sum of the orta çapraz)
    
    write a method that will give the sum of colums
    which has repeting values if non return 0.
    
    write a method that will give the sum of rows
    which has repeting values if non return 0. */
