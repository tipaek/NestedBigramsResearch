...
public class Solution {
    ...
    private static boolean jisnotbusy(ArrayList<Integer> p) {
        for(int i=0;i<J.size();i++){
            if (J.get(i).get(0) > p.get(0) && J.get(i).get(0) < p.get(1)){
                return false;
            } else if (J.get(i).get(1) > p.get(0) && J.get(i).get(1) < p.get(1)){
                return false;
            } else if ((p.get(0) > J.get(i).get(0) && p.get(0) < J.get(i).get(1)) || (p.get(1) > J.get(i).get(0) && p.get(1) < J.get(i).get(1))){
                return false;
    ...
    private static boolean cisnotbusy(ArrayList<Integer> p) {
        for(int i=0;i<C.size();i++){
            if (C.get(i).get(0) > p.get(0) && C.get(i).get(0) < p.get(1)){
                return false;
            } else if (C.get(i).get(1) > p.get(0) && C.get(i).get(1) < p.get(1)){
                return false;
            } else if ((p.get(0) > C.get(i).get(0) && p.get(0) < C.get(i).get(1)) || (p.get(1) > C.get(i).get(0) && p.get(1) < C.get(i).get(1))){
                return false;
