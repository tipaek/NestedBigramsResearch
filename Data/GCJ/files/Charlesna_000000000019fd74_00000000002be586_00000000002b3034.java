    ...
    private static void getRes(String[] strs, int t, PrintWriter w) {
        ...
        for (int i = 0; i < l; i++) {
            ...
            while (left <= right && s.charAt(left) != '*') {
                if (left < prefix.length() && s.charAt(left) != prefix.charAt(left)) {
                    w.println("Case #" + t + ": " + "*");
                    return;
                }
                left++;
            ...
            while (left <= right && s.charAt(right) != '*') {
                if (len - right - 1 < suffix.length() && s.charAt(right) != suffix.charAt(suffix.length() - (len - right))) {
                    w.println("Case #" + t + ": " + "*");
                    return;
                }
                right--;
            ...
            if (len - right - 1 > suffix.length()) suffix = s.substring(right + 1);
