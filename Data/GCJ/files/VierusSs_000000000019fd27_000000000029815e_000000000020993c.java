    static void codeJam() throws Exception {
        // Your code here!
    ...
    static void calculateMatrix(int[][] matriz, int tamanyo, FileWriter mywriter, int count) throws IOException {
        mywriter.write("Case #" + count + ": " + calculateDiagonal(matriz) + " " + calculateLine(matriz) + " " + calculateColumn(matriz) + "\n");
    }

    static int calculateDiagonal(int[][] matriz) {
        int suma = 0;
    ...
    static int calculateLine(int[][] matrix) {
        int suma = 0;
    ...
    static int calculateColumn(int[][] matrix) {
        int suma = 0;
        for (int i = 0; i < matrix.length; i++) {
            boolean duplicates = false;
            for (int k = 0; k < matrix.length; k++) {
