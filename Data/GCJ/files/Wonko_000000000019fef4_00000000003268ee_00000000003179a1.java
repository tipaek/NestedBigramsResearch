...
public class Solution implements CJSolution {
  ...
  public void run() {
    ...
    try {
      ...
      for (int tCase = 1; tCase <= t; ++tCase) {
        ...
        for (int i = 0; i < 10; ++i) {
          String cs = map2.get(Integer.valueOf(answer.substring(i, i + 1)));
          if (cs != null) {
        ...
        for (int i = 0; i < 10; ++i) {
          try {
            Integer.valueOf(answer.substring(i, i + 1));
  ...
  private void put(String substring, int pos, int dig2) {
