...
public class Solution {
    ...
    public static void solve(int index, int n, int trace) {
        if (n == 2) {
            out.println(String.format("Case #%s: IMPOSSIBLE", index + 1));
            return;
        }
        if (trace % n == 0 && trace <= n * n) {
            ...
            nums[0] = left;
            nums[left - 1] = 1;
            out.println(String.format("Case #%s: POSSIBLE", index + 1));
