...
public class Solution {
    ...
    {
        int i;
        while((i = input_string.indexOf(")(")) != -1)
        {
            input_string = input_string.substring(0,i) + input_string.substring(i+2);
        }
        return input_string;
    }
    static void case(int case) {
        ...
        System.out.println("Case #" + (case + 1) + ": " + resulter(a));
    }
}