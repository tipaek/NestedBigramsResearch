...
class Solution
{
	public static void main(String[] args) {
		Scanner sc=new Scanner(System.in);int t=sc.nextInt();String n1;int n;String s;int a[][];int max;String res;int u;
		...
		for(int t1=1;t1<=t;t1++)
		{
		    ...
		    {
		        n1=sc.next();s=sc.next();
		        if(n1.length()==1){n=Integer.parseInt(n1);ar[n][(int)(s.charAt(0)-'A')]++;}
		        else if(n1.equals("10")) {ten[ct]=s;ct++;}
		    }
