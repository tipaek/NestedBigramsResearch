...
public class Solution {
    ...
    private static void handleFluctuation(final List<BitPair> pairs, final BitPair firstSame, final BitPair firstDifferent, final Scanner scanner) {
        if(firstSame == null) {
    ...
    private static BitPair getBitPair(int length, int i, final Scanner scanner) {
