...
public class Solution {
	 ...
	 public static boolean comprobarActividad(
		 ...
		 for(int i = 0;i < numeroActividades;i++){
			 ...
			 if(
					 (tiempoFin < rangoSuperior && tiempoInicio > rangoInferior)
					 ||
					 (tiempoFin > rangoInferior && tiempoInicio < rangoInferior)
					 ||
					 (tiempoFin > rangoSuperior && tiempoInicio < rangoSuperior)
			) {
				 huecoOcupado = true;
				 break;
			 }
