...
public class Solution {
	...
	public static final String directory = "/src/jam2020/qualif/problem2";
	...
	public String compute(String[] input) {
		...
		for (int i = 0; i < inputString.length(); i++) {
			next = Integer.valueOf(inputString.substring(i, i + 1));

			for (int a = 0; a < next - current; a++) {
				result.append('(');
			}

			for (int a = 0; a < current - next; a++) {
				result.append(')');
			}
