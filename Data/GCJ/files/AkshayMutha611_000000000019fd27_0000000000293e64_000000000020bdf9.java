...
public class Solution
{
    ...
    void takeInputAndSolve()
    {
        ...
        for (int a=0;a<t;a++)
        {
            ...
            ArrayList<Integer> unsorted_start_times = new ArrayList<Integer>();
            ArrayList<Integer> unsorted_end_times = new ArrayList<Integer>();
                      ...
                      if (a > b && (c < d || e < f ))
                        {
                          ...
                          System.out.println("outputString: "+w);
                  }
                //   outputString = sorted.get(sorted.keySet().toArray()[m]);
            }
}