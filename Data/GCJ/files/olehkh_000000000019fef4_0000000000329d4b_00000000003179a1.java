...
public class Solution {
    ...
    private static Set<Character> notZero = new HashSet<>();
    ...
    public static String getString(Tuple[] rows) {
        for (Tuple row : rows) {
            ...
            if (answer.length() == 1) {
                ...
                chars.add(answer.charAt(0));
                notZero.add(answer.charAt(0));
                continue;
            }
