...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int t = 1; t <= testCases; t++) {
            ...
            str.append("C");
            cMatrix[0][0] = matrix[0][0];
            cMatrix[0][1] = matrix[0][1];
            str.append("J");
            jMatrix[0][0] = matrix[1][0];
            jMatrix[0][1] = matrix[1][1];
            ...
            for (int k = 2; k < matrixSize; k++) {
                ...
                if(!impossible) {
                    for (int l = 0; l < cCount; l++) {
                        if (
                                (matrix[k][0] > cMatrix[l][0] && matrix[k][0] < cMatrix[l][1]) || 
                    ...
                    if (isCAssign) {
                        for (int l = 0; l < jCount; l++) {
                            if (
                                    (matrix[k][0] > jMatrix[l][0] && matrix[k][0] < jMatrix[l][1]) ||
