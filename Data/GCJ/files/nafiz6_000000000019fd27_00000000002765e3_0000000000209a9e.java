                ...
                while (rem>0){
                    ...
                    if (orig.equalsIgnoreCase(rev) || orig.equalsIgnoreCase(both)){
                        ...
                        if (q1==0 && orig.charAt(sameInd)=='0' ||
                            ...
                            //orig or both
                            if (!(q2==0 && orig.charAt(diffInd)=='0' ||
                                    q2==1 && orig.charAt(diffInd)=='1')){
                                bothh=true;
                            }
                            ...
                            //neg or rev
                            if (q2 == 0 && neg.charAt(diffInd) == '0' ||
                                    q2 == 1 && neg.charAt(diffInd) == '1') {
                                negate = true;
                            } else reverse = true;
                        }
					...
					//00001 0011     1100  01001
					//11110 0011     1100  01001
					//10010 0011     1100  01001
					//01101				   11110
					 //10010 1100010011 10000
