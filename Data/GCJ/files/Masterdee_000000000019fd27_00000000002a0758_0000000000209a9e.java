...
//check
            ...
            if (indexToCheckKhacNhau == -1) {
                if (mangThuong[countDone-1] != mangDaoNguoc[countDone-1])
                    indexToCheckKhacNhau = countDone-1;
            }

            if (indexToCheckGiongNhau == -1) {
                if (mangThuong[countDone-1] == mangDaoNguoc[countDone-1])
                    indexToCheckGiongNhau = countDone-1;
            }
        }
