...
public class Solution
{
	...
	static public void main(String args[])throws IOException
	{
		...
		for(int ttt=1;ttt<=tt;ttt++)
		{
			int x=i();
			int y=i();
			String s=func(x,y,ttt);
			String s1=func(y,x,ttt);
			if(s.equals("IMPOSSIBLE") && s1.equals("IMPOSSIBLE"))
			{
				sb.append("Case #"+ttt+": "+"IMPOSSIBLE\n");
			}
			else if(s.equals("IMPOSSIBLE")==false && s1.equals("IMPOSSIBLE"))
			{
				sb.append("Case #"+ttt+": "+s+"\n");
			}
			else if(s.equals("IMPOSSIBLE") && s1.equals("IMPOSSIBLE")==false)
			{
	...
	static String func(int x,int y,int ttt)
	{
		StringBuilder sb=new StringBuilder();
		if(x==0)
		{
