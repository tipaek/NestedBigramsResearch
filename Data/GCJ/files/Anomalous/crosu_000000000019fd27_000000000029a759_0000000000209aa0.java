...
public class Solution {
    ...
    public static Set<Integer> toTraceSig(List<Integer> trace) {
    ...
    public static class LatinSquare {
        ...
        public LatinSquare(LatinSquare other) {
    ...
    public static void advance(LatinSquare l, int next, Map<Set<Integer>, LatinSquare> latinSquares) {
        ...
        for (int i = 0; i < l.n; i++) {
            if (l.isValidSet(next, i + 1)) {
                ...
                if (lastStep) {
                    Set<Integer> traceSig = l.traceSig();
    ...
    public static List<List<Integer>> allTraces(int n) {
        List<List<Integer>> traces = new ArrayList<>(n * n);
        for (int i = 0; i < n * n; i++) {
    ...
    public static LatinSquare convertLatinSquare(LatinSquare base, List<Integer> trace) {
        ...
        for (int i = 0; i < trace.size(); i++) {
            ...
            for (Iterator<Integer> it = unusedBase.iterator(); it.hasNext(); ) {
                int unused = it.next();
    ...
    public static Map<Integer, LatinSquare> solveForN(int n) {
        ...
        for (List<Integer> trace : traces) {
            Set<Integer> traceSig = toTraceSig(trace);
