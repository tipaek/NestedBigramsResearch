...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            plist = new ArrayList<>();
            for (int i = 0; i < n; i++) {
                plist.add(new Pair(sc.nextInt(), sc.nextInt(), i));
            }
            Collections.sort(plist, new PairComparatorPos());
            ...
            sb.append("Case #").append(caseNumber).append(": ").append(sb2).append("\n");
            caseNumber++;
        }
