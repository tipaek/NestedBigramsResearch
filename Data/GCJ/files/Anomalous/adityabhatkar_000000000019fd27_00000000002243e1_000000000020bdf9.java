...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int testIndex = 1; testIndex <= tests; testIndex++) {
            ...
            Collections.sort(intervals, Comparator.comparingInt(interval -> interval.startTime));
            ...
            if (isImpossible) {
                ...
                Collections.sort(intervals, Comparator.comparingInt(interval -> interval.index));
