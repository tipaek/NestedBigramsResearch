...
public class Solution {
    ...
    public static void parentingPartneringReturns() {
        ...
        for (int i = 0; i < t; i++) {
            ...
            outputs.add("Case #" + (i + 1) + ": " + output.toString());
        }
    ...
    public boolean isAvailable(int start, int end) {
        ...
        if (mappedStart == mappedEnd) {
            ...
            if (nodes[mappedStart] == null || nodes[mappedStart].isAvailable(start, (mappedStart + 1) * 60 - 1)) {
                if (nodes[mappedEnd] == null || nodes[mappedEnd].isAvailable(mappedEnd * 60, end)) {
...
class EntryComparator implements Comparator<Entry> {
    ...
    public int compare(Entry o1, Entry o2) {
        int startComparison = Integer.compare(o1.getStart(), o2.getStart());
        return startComparison != 0 ? startComparison : Integer.compare(o1.getEnd(), o2.getEnd());
    }
}
...
class Node {
    ...
    public boolean isAvailable(int start, int end) {
        if (end <= this.start || (start >= this.end && nextNode == null)) {
            ...
            return nextNode.isAvailable(start, end);
        } else {
            return false;
        }
    }
