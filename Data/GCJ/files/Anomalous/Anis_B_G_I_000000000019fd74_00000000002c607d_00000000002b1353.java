...
public class Solution {
    static List<Map.Entry<Integer, Integer>> ans = null;
    ...
    public static void traverse(int level, int curIdx, int currentSum, int targetSum, List<Map.Entry<Integer, Integer>> ansMap, int direction) {
        if (isFindAns) return;
