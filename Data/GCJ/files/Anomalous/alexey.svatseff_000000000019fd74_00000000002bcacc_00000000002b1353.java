...
public class Solution {
    ...
    private static void solveCase(int caseNumber, PrintStream out) throws Exception {
        ...
        int passingCost = calculatePassingCost(bits, maxBit);
        int extraSteps = 0;
        ...
        if (passingCost > 0) {
            ...
            passingCost = calculatePassingCost(bits, maxBit);
    ...
    private static int calculatePassingCost(boolean[] bits, int maxBit) {
        int passingCost = 0;
    ...
    private static int getMaxBit(boolean[] bits) {
        int maxBit = 0;
