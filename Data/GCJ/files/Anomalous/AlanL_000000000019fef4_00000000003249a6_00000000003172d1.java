...
public class Solution {
    ...
    static void handleCaseD2(int n, long[] arr) {
        if (n == 1) {
    ...
    static void handleCaseD3(int n, long[] arr) {
        Arrays.sort(arr);
        if (n == 1) {
            ...
            if (arr[0] == arr[1] && arr[1] == arr[2]) {
                ...
                System.out.println(1);
            } else if (arr[2] % 2 == 0 && arr[2] / 2 == arr[0]) {
                System.out.println(1);
            } else if (arr[2] % 2 == 0 && arr[2] / 2 == arr[1]) {
                System.out.println(1);
            } else {
                System.out.println(2);
            }
    ...
    static int getMaxCount(long[] arr) {
        int counter = 1, max = -1;
