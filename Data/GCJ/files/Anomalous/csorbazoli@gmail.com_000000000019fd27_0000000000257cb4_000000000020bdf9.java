...
public class Solution {
    ...
    private void processTestCase(Data data, int caseNum, Scanner scan, PrintWriter out) {
        if (data == null) {
            data = new Data();
        }
        data.init(scan.nextInt());
        IntStream.range(0, data.n)
                 .forEach(idx -> processActivity(data, idx, scan.nextInt(), scan.nextInt()));
