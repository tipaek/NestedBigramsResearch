...
public class Solution {
    ...
    static final int MAX_T = 60;
    static final int MAX_BUFFER_SIZE = 1 << 16;
    static final int MAX_SEGMENT_TREE_SIZE = 10000000;
    ...
    public static void recurse(int pos, long x, long y, ArrayList<Integer> list) {
        if (x == xx && y == yy) {
            poss = true;
            if (savedList == null || savedList.size() > list.size()) {
        ...
        ArrayList<Integer> li1 = new ArrayList<>(list);
        ArrayList<Integer> li2 = new ArrayList<>(list);
        ArrayList<Integer> li3 = new ArrayList<>(list);
        li1.add(1);
        li2.add(-1);
        li3.add(2);
        list.add(-2);
    ...
    static int binsFirstPos(ArrayList<Integer> list, int ele) {
        int pos1 = Collections.binarySearch(list, ele);
        if (pos1 > -1) {
            int pos2 = Collections.binarySearch(list, ele - 1);
            if (pos2 < 0) return Math.abs(pos2) - 1;
    ...
    static class SegmentTree {
        static long[] tree = new long[MAX_SEGMENT_TREE_SIZE];
        static long[] lazy = new long[MAX_SEGMENT_TREE_SIZE];
        static long[] tree2 = new long[MAX_SEGMENT_TREE_SIZE];
        static long[] lazy2 = new long[MAX_SEGMENT_TREE_SIZE];
    ...
    static class Reader {
        ...
        private void fillBuffer() throws IOException {
            bytesRead = din.read(buffer, bufferPointer = 0, MAX_BUFFER_SIZE);
