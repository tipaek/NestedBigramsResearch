        ...
        while (bitsKnown < numBits) {
            ...
            if (bitsKnown > 0 && (queriesMade % 10 == 1)) {
                ...
                if (workingWithSaveForLater) {
                    ...
                    currentSaveForLaterIndex += lastWasFront ? 0 : 1;
                } else {
                    bitPositionRequested = lastWasFront ? (numBits - currentRegularIndex - saveForLaterEndIndex) : (currentRegularIndex + 1 + saveForLaterEndIndex);
                    lastWasFront = !lastWasFront;
                    currentRegularIndex += lastWasFront ? 0 : 1;
                }
