...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t < testCases; t++) {
            ...
            if (d == 2) {
                if (angleCount.containsValue(2)) {
                    result.append(0);
                } else {
                    result.append(1);
                }
            } else if (d == 3) {
                if (angleCount.containsValue(3)) {
                    result.append(0);
                } else {
                    boolean found = false;
                    for (Map.Entry<Double, Integer> entry1 : angleCount.entrySet()) {
                        for (Map.Entry<Double, Integer> entry2 : angleCount.entrySet()) {
