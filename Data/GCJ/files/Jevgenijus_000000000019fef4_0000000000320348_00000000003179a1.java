...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int t = 0; t < T; t++) {
			...
			List<Pair<Integer, String>> inp = new ArrayList<Pair<Integer,String>>();
			for(int i = 0; i < sz; i++) {
			...
			Collections.sort(inp, new Comparator<Pair<Integer, String>>() {
			    public int compare(Pair<Integer, String> obj1, Pair<Integer, String> obj2) {
			...
			for(int i =0;i < inp.size(); i++) {
				Pair<Integer, String> p =inp.get(i);
				int M = p.first;
