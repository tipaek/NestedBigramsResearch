    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testSetSize; ++i) {
            ...
            for( j= 0; j< numberActivities;j++){
                ...
                if(!isImpossible){
                    result = tryGiveActivity(startingTime,endingTime,(ArrayList<Integer>)cameronStarting,(ArrayList<Integer>)cameronEnding);
                    if(result == 0){
                        result = tryGiveActivity(startingTime,endingTime,(ArrayList<Integer>)jamieStarting,(ArrayList<Integer>)jamieEnding);
                        if(result == 0){
                            isImpossible = true;
                            answer = "IMPOSSIBLE";
