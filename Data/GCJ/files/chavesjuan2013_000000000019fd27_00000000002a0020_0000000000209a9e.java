...
class Solution {
    ...
    public static void main(String[] args) throws IOException {
            ...
            for(int i = 0; i < B/10; ++i)
            {
                for(int j = 5*i + 1; j <= 5*(i+1); ++j)
                {
                    ...
                    if(a==b)
                    {
                        if(a==0)
                        {
                            listas[4*i].add(new pair(j,B+1-j));
                        }
                        else
                        {
                            listas[4*i+3].add(new pair(j,B+1-j));
                        }
                    }
                    else {
                        if(a==1){
                            listas[4*i+2].add(new pair(j,B+1-j));
                        }
                        else
                        {
                            listas[4*i+1].add(new pair(j,B+1-j));
                        }
                    }
                }
            }
        ...
        if(!listaDef01.isEmpty())
        {
            System.out.println(listaDef01.get(0).a);
            String s = br.readLine();
            System.out.println(listaDef01.get(0).b);
