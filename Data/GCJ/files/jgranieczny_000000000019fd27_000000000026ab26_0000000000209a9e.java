...
//                try{
//                    throw new Error("count: "+count +" inv: "+invert+ " rev: "+reverse);
//                }catch (Error e){
//                    e.printStackTrace();
//                }
                count=count%10;
                ...
                for(int k=0;k<result.length&&result[k]!=-1&&result[result.length-1-k]!=-1;k++){
...
//            }
                ...
                if(!invert)
                    ...
                    result[i]=Math.abs(in.nextInt()-1);
                            try{
                throw new Error("countTot: "+countTot +" i: "+i+ " result[i]: "+reverse);
            }catch (Error e){
                e.printStackTrace();
            }
                count++;
