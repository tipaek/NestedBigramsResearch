...
public class Solution {
    ...
    public static boolean overlap(Activity act1, Activity act2) {
        return (act2.start == act1.start
                || act2.start > act1.start && act2.start < act1.end
                || act1.start > act2.start && act1.start < act2.end
        );
