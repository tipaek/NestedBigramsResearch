...
public class Solution {
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int caseNum = 1; caseNum <= test_case; ++caseNum) {
                new Solution().getAns(caseNum, scanner);
            }
    ...
    public void getAns(int caseNum, Scanner scanner) {
        ...
        String prevLeft = pre.substring(0, index);
        String prevRight = "" ;
        if (index < pre.length()) {
            prevRight = pre.substring(index+1);
        }
        ...
        System.out.println(String.format(output, caseNum, result));
    }
