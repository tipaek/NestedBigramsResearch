         ...
         //      System.out.println("indexes= "+indexes);
                 ...
                 for(int k=0;k<indexes.size();k++)
               {
                  // System.out.println("str[i] is  "+str[i]);
                    ...
                    //System.out.println("entered value is "+ str[indexes.get(k)]);
       ...
       ////////////////////////////////////////////
                ...
                for(int h=0;h<sus1.size();h++)
               {
                    ...
                    if(g!=h)
                   {
                       ...
                       if(sus1.get(g)<sus2.get(h)&&sus2.get(g)>sus2.get(h)||   sus1.get(h)>sus1.get(g)&&sus1.get(h)<sus2.get(g) || sus1.get(h)>sus1.get(g)&&sus2.get(h)<sus2.get(g)||  sus1.get(h)<sus1.get(g)&&sus2.get(h)>sus2.get(g))
                       {//System.out.println("i iis  "+i);
                           flag=false;
                           break pqr;
                       }
                   }
