        ...
        for(int testIndex = 0 ;testIndex < testCount ; testIndex++){
            ...
            taskList.sort(new Comparator<Task>() {
                ...
                public int compare(Task o1, Task o2) {
                    ...
                    return (o1.getStartTime() - o2.getStartTime() != 0)  ? (o1.getStartTime() - o2.getStartTime()): (o1.getEndTime() - o2.getEndTime());
                }
            ...
            for(Task t:taskList ){
                ...
                if(jt == null){
                    ...
                    if(t.getStartTime() >= ct.getEndTime()){
                        t.setAssignTo("C");
                    }else if(t.getStartTime() >= jt.getEndTime()){
                        t.setAssignTo("J");
                    }else{
                        impossible = true;
                        break;
              ...
              /*  if(t2 == null){
                    ...
                    if(t1.getAssignTo().equals(t2.getAssignTo())){
                    ...
                    if( t.getStartTime() >=  t1.getEndTime() && !t1.getAssignTo().equals(t2.getAssignTo())){
                        ...
                        t.setAssignTo(t1.getAssignTo());
                    }else  if( t.getStartTime() >=  t2.getEndTime() && !t1.getAssignTo().equals(t2.getAssignTo())){
                        //   System.out.println(101);
