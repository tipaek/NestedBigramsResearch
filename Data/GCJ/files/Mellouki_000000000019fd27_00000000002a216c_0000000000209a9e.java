	...
	public static void main(String[] args) {
        ...
        for (int i = 1; i <= t; ++i) {
        	...
        	if(B == 10) {
        		String result= "";
        		for (int j = 1; j <= 10; j++) {
        			System.out.println(j); System.out.flush();
        			result += in.nextInt();
        		}
        	...
        	if(B == 20) {
    			...
    			for(int b = 16; b <= 20; b++) {
    				System.out.println(b); System.out.flush();
    				chunk2[b-1] = in.nextInt() == 1;
    			}
    			//
    			for(int b = 6; b <= 10; b++) {
    				System.out.println(b); System.out.flush();
    				chunk3[b-1] = in.nextInt() == 1;
    			}
    			for(int b = 11; b <= 15; b++) {
    				System.out.println(b); System.out.flush();
    				chunk4[b-1] = in.nextInt() == 1;
    			}
    			//
    			for(int b = 1; b <= 5; b++) {
    				System.out.println(b); System.out.flush();
    			...
    			for(int b = 6; b <= 10; b++) {
    				System.out.println(b); System.out.flush();
    				chunk6[b-1] = in.nextInt() == 1;
    				result[b-1] = chunk6[b-1];
    			}
    			//
