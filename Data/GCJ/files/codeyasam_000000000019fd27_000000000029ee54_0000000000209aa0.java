...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= t; ++i) {
            ...
            boolean isPossible = checkPossiblity(nMatrix, latinMatrix, kTrace);
            if (isPossible) {
    ...
    public static boolean checkPossiblity(int n, int[][] elements, int kTrace) {  
        ...
        if (n == 1) {
            ...
            for (int i = 0; i < n -1; i++) {
                checkPossiblity(n - 1, elements, kTrace);
                if (n % 2 == 0) {
                    swap(elements, i, n - 1);
                } else {
                    swap(elements, 0, n - 1);
            ...
            return checkPossiblity(n - 1, elements, kTrace);
        }
