...
public class Solution {
    ...
    private static String getResult(int caseNumber, int[][] matrix) {
    ...
    private static int getColNumWithDuplicates(int[][] matrix) {
        int col = 0;
    ...
    private static int getRowNumWithDuplicates(int[][] matrix) {
        int row = 0;
        for (int i = 0; i < matrix.length; i++) {
            Set<Integer> set = new HashSet<>();
            for (int j = 0; j < matrix[i].length; j++) {
