            ...
            if(slices == 1) {
                ...
                while(pizza.get(longest) < numSatisf) {
                    if(pizza.containsKey(longest * 2)) {
                        ...
                        cut++;
                    } else if (pizza.containsKey(longest * 5)) {
                        slice(longest * 5, longest, pizza);
                        cut++;
                    } else if (pizza.containsKey(longest * 7)) {
                        slice(longest * 7, longest, pizza);
                        cut++;
                    } else if (pizza.containsKey(longest * 11)) {
                        slice(longest * 11, longest, pizza);
                        cut++;
                    } else if (pizza.containsKey(longest * 13)) {
                        slice(longest * 13, longest, pizza);
                        cut++;
                    } else {
