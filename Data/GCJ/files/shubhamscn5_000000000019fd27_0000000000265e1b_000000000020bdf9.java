...
{
	static class compareStart implements Comparator<obj>
	{
    ...
    public static void main(String args[])throws IOException
    {
        ...
        while(t-->0)
        {
            ...
            int schIndex=0;
            PriorityQueue<obj> pq1=new PriorityQueue<obj>(1,new compareStart());
            PriorityQueue<obj> pq2=new PriorityQueue<obj>(1,new compareStart());
