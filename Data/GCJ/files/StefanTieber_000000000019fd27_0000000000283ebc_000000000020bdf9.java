...
class Solution {
        ...
        try {
            ...
            for (int i = 0; i < numberOfSets; i++) {
                ...
                for (int j = 0; j < numberOfLines; j++) {
                    ...
                    activities.add(new Activity(Integer.parseInt(parts[0]), Integer.parseInt(parts[1]), j));
                }
    ...
    private static String solve(List<Activity> activities) {
        ...
        activities.sort(Comparator.comparing(a -> a.id));
...
class Activity {
    ...
    public Activity(int begin, int end, int id) {
        this.begin = begin;
        this.end = end;
        this.id = id;
        this.taken = 0;
