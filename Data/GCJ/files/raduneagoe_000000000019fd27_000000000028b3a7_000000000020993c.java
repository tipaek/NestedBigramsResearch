...
public class Solution {
    ...
    public static boolean validColumn(int[][] matrix, int column) {
        Set<Integer> s = new HashSet();
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; ++i) {
            ...
            for (int j = 0; j < N; ++j) {
                ...
                countRow += validRow(matrix, j) ? 0 : 1;
                countColumn += validColumn(matrix, j) ? 0 : 1;
            }
            System.out.printf("Case #%d: %d %d %d%n", i, diagonalSum, countRow, countColumn);
        }
    }
}