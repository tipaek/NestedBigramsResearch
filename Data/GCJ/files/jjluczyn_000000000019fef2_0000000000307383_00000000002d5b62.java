...
//                    long Y = YY;
        ...
        //            pw.println();
                    ...
                    if ((Xc2&Yc2) == 0 && Xc2 !=0 && Yc2 !=0){
                        long Yc2aux = Yc2;
                        long Xc2aux = Xc2;
                        if (Xc2aux > Yc2aux){
                            while (Yc2aux<Xc2aux && (Xc2aux&Yc2aux)==0 && (((Long.highestOneBit(Xc2aux|Yc2aux)<<1)-1)!=Xc2aux+Yc2aux)){
                                Yc2aux = Long.highestOneBit(Yc2aux)<<1 | Yc2aux;
                            }
                        } else {
                            while (Xc2aux<Yc2aux && (Yc2aux&Xc2aux)==0 && (((Long.highestOneBit(Yc2aux|Xc2aux)<<1)-1)!=Yc2aux+Xc2aux)){
                                Xc2aux = Long.highestOneBit(Xc2aux)<<1 | Xc2aux;
                            }
                        }
                        if (((Yc2aux&Xc2aux) == 0) && ((Long.highestOneBit(Yc2aux|Xc2aux)<<1)-1)==Yc2aux+Xc2aux) {
                            solved = true;
                            int len = Math.max(Long.toBinaryString(Yc2aux).length(), Long.toBinaryString(Xc2aux).length());
                            if (len < minLen) {
                                minLen = len;
                                sol = new char[100];
                                String sXc2aux = new StringBuilder(Long.toBinaryString(Xc2aux)).reverse().toString();
                                ...
                                if (Yneg && sYc2aux.charAt(sYc2aux.length() - 1) == '1') {
                                    sol[sYc2aux.length() - 1] = 'S';
                                } else if (sYc2aux.charAt(sYc2aux.length() - 1) == '1') {
                                    sol[sYc2aux.length() - 1] = 'N';
                                }
                            }
                        }
