...
//        if (true) {
            ...
            for (int test = 1; test <= numTests; test++) {
                long l = in.nextLong();
                long r = in.nextLong();
                Solution sol = fast(l, r);
                out.printf("Case #%d: %d %d %d\n", test, sol.customers, sol.l, sol.r);
            }
        }

        private Solution slow(long l, long r) {
            long c = 0;
            for (int i = 1; ; i++) {
                if (l >= r && l >= i) {
                    l -= i;
            ...
            return new Solution(c, l, r);
        }

        private Solution fast(long l, long r) {
        ...
        class Solution {
            ...
            Solution(long customers, long l, long r) {
