...
class program{
    ...
    //String numberOfTestCases = args[0];
    int numberCase = 1;
    for(int o = 1; o<args.length; o++) {
        ...
        computeOutput(numberCase,numberOfRows,matrix);
        o+=numberOfRows;
        numberCase++;
    }	
    ...
    public static void computeOutput(int numberCase,int numberOfRows,List<List<Integer>> matrix){
        ...
        System.out.println("Case #"+numberCase+ ": " + sumOfDiagonal + " " + totalDuplicatesRows + " " + totalDuplicatesColumn);
    }
