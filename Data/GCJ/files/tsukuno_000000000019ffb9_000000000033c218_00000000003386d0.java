...
public class Solution {
  ...
  // 1 => æœ€åˆã¨æœ€å¾Œã§ 2å€‹è¡Œã‘ã‚‹ï¼Ÿ
  // odd => è¡Œã£ã¦å¸°ã£ã¦ãã‚‹ãŒã§ãã‚‹ (å¶æ•°å€‹ãªã‚‰å…¨éƒ¨å–ã‚Œã‚‹ï¼Ÿ å¥‡æ•°å€‹ã ã¨ 1å€‹å–ã‚Œãªã„)
  // even => ãã®ã¾ã¾é€šã‚ŠæŠœã‘ã‚‹ã—ã‹ã§ããªã„ (å…¨éƒ¨å–ã‚Œã‚‹)
