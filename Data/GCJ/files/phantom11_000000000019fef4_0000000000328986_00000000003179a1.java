        ...
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            if (U == 2) {
                ...
                if (!impossible) {
                    ...
                    res = solveImpossible(Q, R, lengths, characters);
                }
            }
...
//        DebugUtils.debug(ThreadLocalRandom.current().nextInt((int)permutations.size()));
        ...
        public char[] solveImpossible(long Q[], String R[], int length[], HashSet<Character> characters) {
            int N = 10000;
            char result[] = new char[10];
            HashSet<Character> used = new HashSet<>();
            for (int i = 0; i < N; i++) {
            ...
            HashSet<Character[]> permutations = new HashSet<>();
            generatePermutations(9, perm, permutations);
            int M = ThreadLocalRandom.current().nextInt((int) permutations.size());
            index = 0;
            for (Character c[] : permutations) {
                if (index == M) {
                    for (int i = 1; i < 10; i++) {
