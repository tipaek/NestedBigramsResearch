        ...
        for (int i = 0; i < t; i++) {
            ...
            for (int j = 0; j < n; j++) {
                ...
                for (int k = 0; k < n && !done; k++) {
                    if (sortedStartingTimes[j] == startingTimes[k] && !sorted[k]) {
            ...
            for (int j = 0; j < n; j++) {
                if (sortedAssignments[j] == 'C') {
                    for (int k = sortedStartingTimes[j]; k <= sortedEndingTimes[j]; k++) {
                        ...
                        if (cameron[k] == 2 && cameronCounter == 1 && k != sortedStartingTimes[(int)Math.min(j + 1, n - 1)]) {
                            possible = false;
                    ...
                    for (int k = sortedStartingTimes[j]; k <= sortedEndingTimes[j]; k++) {
                        jamie[k] = jamie[k] + 1;
                        if (jamie[k] == 2 && jamieCounter == 1 && k != sortedStartingTimes[(int)Math.min(j + 1, n - 1)]) {
                            possible = false;
