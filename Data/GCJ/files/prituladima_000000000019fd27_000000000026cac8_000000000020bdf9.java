...
//            Arrays.fill(ans, 'C');
            ...
            for (Act act : input) {
                ...
                if(ans[act.getId()] == '\u0000') throw new RuntimeException();
            }
    ...
    private void dfs(boolean[] used, Act from, char[] ans, int deep, Graph graph) {
        ...
        if(ans[from.getId()] != '\u0000') throw new RuntimeException();
        ans[from.getId()] = deep % 2 == 0 ? 'C' : 'J';
//        if (deep % 2 == 0) {
//        } else {
//            ans[from.getId()] = 'J';
//        }
