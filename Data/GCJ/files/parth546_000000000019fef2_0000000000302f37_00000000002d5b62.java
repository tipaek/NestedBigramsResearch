...
class CustomClass{
    ...
    CustomClass[] getChildren(){
       ...
       ans[0]= new CustomClass(this.x+(int)Math.pow(2,this.depth),this.y,this.moves+"E",this.depth+(byte)1);
       ans[1]= new CustomClass(this.x-(int)Math.pow(2,this.depth),this.y,this.moves+"W",this.depth+(byte)1);
       ans[2]= new CustomClass(this.x,this.y+(int)Math.pow(2,this.depth),this.moves+"N",this.depth+(byte)1);
       ans[3]= new CustomClass(this.x,this.y-(int)Math.pow(2,this.depth),this.moves+"S",this.depth+(byte)1);
       return ans;
    }
}
