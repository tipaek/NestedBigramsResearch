...
public class Solution {
    ...
    public static void main(String[] args){
        ...
        for(int t=0;t<T;t++){
            ...
            for(int i=0;i<N;i++){
                ...
                activity[2]=i;
                addInOrder(listOfActivities, activity);
            }
            ...
            for(int i=0;i < end;i++){
                ...
                else if(!areOverlapped(cameronActivities.getLast(), activity)){
                    cameronActivities.add(activity);
                    schedule[activity[2]]='C';
                }
                ...
                else if(!areOverlapped(jamiesActivities.getLast(), activity)){
                    jamiesActivities.add(activity);
                    schedule[activity[2]]='J';
                }
                else{
    ...
    private static boolean areOverlapped(Integer[] act1, Integer act2[]){
