...
public class Solution {
	...
	//4- Nothing Happened
	//-1 Invalid
	public static int compare(String s1, String s2, boolean flag){
		...
		if(s1.equals(s2))
			...
			return 1;
		else if(rs1.equals(s2) && flag)
			return 2;
		else if(crs1.equals(s2) && flag)
			return 3;
		else
			return -1;
	}
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < t; i++){
			...
			String og1 = g1;
			g1 = read(0,5);
			int mode = Math.max(compare(g1,og1,false),compare(g1,g4,true));
			if(mode == 2 || mode == 3){
				g4 = adjust(mode, og1);
			}else
				g4 = adjust(mode,g4);
			...
			og1 = g1;
			g1 = read(0,5);
			mode = Math.max(compare(g1,og1,false),compare(g1,g4,true));
			//System.out.println(g1+" " + og1+ " " + " "+  g4 + " " +compare(g1,og1,false) + " " + compare(g1,g4,true));
			//System.out.println("second mode: " + mode);
			String g3;
			if(mode == 2 || mode == 3){
				g3 = adjust(mode, g2);
				g4 = adjust(mode, og1);
