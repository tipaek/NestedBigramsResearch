...
public class Solution {
  ...
  static final int[][] excN4K6 = {{2, 4, 1, 3}, {4, 1, 3, 2}, {1, 3, 2, 4}, {3, 2, 4, 1}};
  static final int[][] excN4K10 = {{2, 4, 3, 1}, {1, 3, 4, 2}, {3, 1, 2, 4}, {4, 2, 1, 3}};
  static final int[][] excN4K14 = {{4, 2, 3, 1}, {2, 3, 1, 4}, {3, 1, 4, 2}, {1, 4, 2, 3}};
    ...
    for (int t = 1; t <= T; t++) {
      ...
      if (possible) {
        if (K % N == 0) {
          ...
          printSol(out, N, K, excN4K6);
        } else if (N == 4 && K == 10) {
          printSol(out, N, K, excN4K10);
        } else if (N == 4 && K == 14) {
          printSol(out, N, K, excN4K14);
        } else {
          // lookup
          int[][] sol = new int[N][N];
          for (int r = 0; r < N; r++) {
  ...
  static void printSol(OutputWriter out, int N, int K, int[][] sol) {
    ...
    if (sum != K) {
      throw new RuntimeException("k not correct");
    }
  }
    ...
    for (int i = 4; i <= 50; i++) {
      ...
      for (int a = 1; a <= i; a++) {
        for (int b = 1; b <= i; b++) {
          ...
          if (i == 4) {
            System.err.println(a + ", " + b + " => " + (a * (i - 2) + b * 2));
          }
          for (int c = b + 1; c <= i; c++) {
            if (c == a) {
              continue;
