...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for (int caso = 0; caso < cases; caso++) {
            ...
            Actividad carlos = siguienteActividad(actividades);
            carlos.player = "C";
            jugadas.add(carlos);
            actividades = quitarActividad(actividades, carlos);

            Actividad juan = null;

            StringBuffer solucion = new StringBuffer("C");
            ...
            while (actividades.length != 0) {
                ...
                if (solapan(carlos, siguienteActividad)) {
                    if (juan == null) {
                        solucion.append("J");
                        ...
                        if (solapan(siguienteActividad, juan)) {
                            imposible = true;
                        } else {
                            solucion.append("J");
                            juan = siguienteActividad;
