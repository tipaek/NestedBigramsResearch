...
class CodeJam {
  ...
  private static ArrayList<ArrayList<Integer>> readMatrix(int dimension)
  ...
  private static ArrayList<Integer> readRow(int length)
      throws IOException, IllegalArgumentException {
  ...
  private static void solveMatrix(
  ...
  private static ArrayList<ArrayList<Integer>> invertMatrix(ArrayList<ArrayList<Integer>> matrix, int dimension) {
