...
public class Solution {
    ...
    for (int t = 1; t <= T; t++) {
      ...
      if (X % 2 == 0 && Y % 2 == 0) {
        ...
        if (!answer.equals("IMPOSSIBLE")) {
          int l = answer.length();
          if (X % 2 != 0) {
            answer2 = "W" + find2(X + 1, a, X + 1 > 0 ? "E" : "W", l);
            if (answer2.contains("IMPOSSIBLE")) {
              answer2 = "E" + find2(X - 1, a, X - 1 > 0 ? "E" : "W", l);
            } else {
              answer3 = "E" + find2(X - 1, a, X - 1 > 0 ? "E" : "W", l);
            ...
            answer2 = "S" + find2(Y + 1, a, Y + 1 > 0 ? "N" : "S", l);
            if (answer2.contains("IMPOSSIBLE")) {
              answer2 = "N" + find2(Y - 1, a, Y - 1 > 0 ? "N" : "S", l);
            } else {
              answer3 = "N" + find2(Y - 1, a, Y - 1 > 0 ? "N" : "S", l);
              if (!answer3.contains("IMPOSSIBLE") && answer3.length() < answer2.length()) {
                answer2 = answer3;
              }
            }
  ...
  private static String find2(Long z, List<Long> a, String dir, int i) {
    Long zz = Math.abs(z);
