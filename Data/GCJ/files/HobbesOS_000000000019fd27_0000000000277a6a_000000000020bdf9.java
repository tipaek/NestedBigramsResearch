    ...
    public static void main(String[] args) {
        ...
        for(int i = 1; i <= numCases; i++) {
            ...
            if(sortedActivities.size() > 2) {
                ...
                for(int time = 0; time <= (1440 * 3); time++) {
                    if(sortedActivities.get(nextActivityIndex)[0] <= time) {
                        ...
                        if (nextActivity[0] >= sortedActivities.get(currentEActivity)[1]) {
                ...
                for(int[] array : sortedActivities) {
                    if (array[0] > array[1]) {
                        impossible = true;
                        break;
                    }
                ...
                if(impossible) {
                    ...
                    System.out.printf("Case #%s: %s%n", i, String.valueOf(solution));
                }
            } else {
