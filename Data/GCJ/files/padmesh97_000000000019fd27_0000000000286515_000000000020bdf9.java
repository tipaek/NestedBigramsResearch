...
class Solution
{
	...
	static boolean cCheck(int s,int e)
	{
        ...
        {
            if(((s>=cslot.get(i) && s<cslot.get(i+1)) || (e>cslot.get(i) && e<=cslot.get(i+1))) || (cslot.get(i)>=s && cslot.get(i+1)<=e) || (cslot.get(i)<=s && cslot.get(i+1)>=e) )
            vacant=false;
        }
	...
	static boolean jCheck(int s,int e)
	{
	    ...
	    else
	    {
            ...
            {
                if(((s>=jslot.get(i) && s<jslot.get(i+1)) || (e>jslot.get(i) && e<=jslot.get(i+1))) || (jslot.get(i)>=s && jslot.get(i+1)<=e) || (jslot.get(i)<=s && jslot.get(i+1)>=e) )
                vacant=false;
            }
	    }
