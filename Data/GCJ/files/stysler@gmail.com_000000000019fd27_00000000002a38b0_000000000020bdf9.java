...
public class Solution {
	...
	private static boolean canPersonDoIt(ArrayList<Activity> personActivities, Activity newActivity) {
		...
		for(Activity currentActivity : personActivities) {
			...
			if(currentActivity.getStartTime() == newActivity.getStartTime()) return false;			
			if(newActivity.getStartTime() < currentActivity.getStartTime() && newActivity.getEndTime() > currentActivity.getStartTime() ) {
				return false;
			}
