...
public class Solution {
    ...
    private static String getResult(Scanner in){
        ...
        for(int x = 0;x< 10000;x++) {
            ...
            if(seenFirst.size() != 9) {
                seenFirst.add(character);
                for (int s = 0; s < nextLine.length(); s++) {
                    char curr = nextLine.charAt(s);
                    if (!seenFirst.contains(curr)) {
                        seenAll.add(nextLine.charAt(s));
                    }
                }
                if (seenAll.contains(character)) {
                    seenAll.remove(character);
                }
            }
        ...
        String resultString = seenAll.iterator().next().toString();
