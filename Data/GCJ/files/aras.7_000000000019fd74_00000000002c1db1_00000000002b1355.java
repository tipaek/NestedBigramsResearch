...
class Solution {
    ...
    static class Dancer {
        ...
        public boolean hasToBeEliminated() {
            ...
            double avg = (float) value / (float)neighboursCount;
            return avg > (float)score;
        }
    }
    ...
    public static void main(String []args) {
        ...
        for (int testNumber = 1; testNumber <= testCount; testNumber++) {
            ...
            while(hasEliminated) {
                ...
                Set<Integer> iterationToDelete = new HashSet<>();
                int itCount = -1;
                // check delete
                while(it.hasNext()) {
                    itCount++;
                ...
                while(it.hasNext()) {
                    ...
                    Dancer dancer = it.next();
                    // delete and update
                    if (iterationToDelete.contains(itCount)) {
                        if (dancer.up != null) {
