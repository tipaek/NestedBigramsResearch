 import java.util .*;
    ...
    public class Solution {
        public static void main(String[] args) {
            ...
            for(int i = 0; i < tasks.length; i++){
                if(isAvailable(cTasks, tasks[i][0], tasks[i][1])){
                ...
                else if(isAvailable(jTasks, tasks[i][0], tasks[i][1])){
        ...
        //     for(int i = 0; i < tasks.length; i++){
        //         if(tasks[i][0] > x && tasks[i][0] < y && tasks[i][1] > x && tasks[i][1] < y){
        //             return false;
        //         }
        //         if(tasks[i][0] < x && tasks[i][0] > y && tasks[i][1] < x && tasks[i][1] > y){
        //             return false;
        ...
        //             return false;
        //         }
        //         if(tasks[i][0] < x & tasks[i][1] > x){
        //             return false;
        //         }
        //         if(tasks[i][0] < y && tasks[i][1] > y){
        //             return false;
        //         }
        //         if(tasks[i][1] > x && tasks[i][1] < y){
        //             return false;
        //         }
        //         if(x == tasks[i][0] || y == tasks[i][1]){
        //             return false;
        //         }
        ...
        // public static boolean isPossible(int [][] tasks){
        //     int max = 24 * 60;
        //     for(int i = 0; i < max; i++){
        //         int num = 0;
        ...
        public static boolean isAvailable(int [][] tasks, int x,int y){
            for(int i = 0; i < tasks.length; i++){
                ...
                for(int j = start; j <= end; j++){
                    if((x > start && x < end) || (start > x && start < y)){
                        return false;
                    }
                }
            }       
