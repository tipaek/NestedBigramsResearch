...
//                System.out.println("this start: " + this.s);
//                System.out.println("this finish : " + this.f);
//                System.out.println("other start: " + other.s);
//                System.out.println("other finish: " + other.f);
                boolean overlaps =  ((this.s >= other.s  && this.s < other.f) || (this.f <= other.f && this.f > other.s) || (other.s >= this.s  && other.s < this.f) || (other.f <= this.f && other.f > this.s));
                if (overlaps) {
