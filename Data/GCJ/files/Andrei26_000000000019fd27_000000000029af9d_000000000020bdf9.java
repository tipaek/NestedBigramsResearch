            ...
            for(int ac =0; ac < activities; ac++){
                ...
                try{
                    ...
                    for(int x = activityStart; x <= activityEnd;x++){
                        if((c[x]==1) &&((c[x+1] == 1) ||(activityStart-activityEnd==0))){
                             throw new Error("a");
                        }else{
                            c[x]=1;
                            tries++;
                    ...
                    try{
                        for(int x = activityStart; x<=activityEnd;x++){
                            if((j[x]==1) &&((j[x+1] == 1) ||(activityStart-activityEnd==0))){
                                 throw new Error("a");
                            }else{
                                j[x]=1;
                                tries++;
                    ...
                    last.append("J");
                        ...
                        last.append("IMPOSIBILE");
                    }
                    
                }
            } 

            if(last.toString().contains("IMPOSIBILE")){
                last.setLength(0);
                last.append("IMPOSIBLE");
            }
