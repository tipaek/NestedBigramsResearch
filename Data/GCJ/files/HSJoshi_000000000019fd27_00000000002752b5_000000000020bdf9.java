	...
	private static char getChar(Timestamp st, Timestamp et) {
		...
		for(int i=0;i<startTimes.size();i++) {
			if((st.before(startTimes.get(i)) || st.equals(startTimes.get(i))) && et.after(startTimes.get(i))
				...
				|| ((st.equals(startTimes.get(i)) || st.after(startTimes.get(i))) && et.before(endTimes.get(i)))
				|| (st.after(startTimes.get(i)) && (et.before(endTimes.get(i)) || et.equals(endTimes.get(i))))
