...
public class Solution {
    ...
    private static String solve2(List<Integer> time, int length) {
        ...
        for (int i = 0; i < length; i++) {
             if (cameronStart <= pairs.get(i).getEndTime() && cameronEnd <= pairs.get(i).getStartTime() || pairs.get(i).getEndTime() < cameronStart && pairs.get(i).getStartTime() < cameronStart) {
                cameronStart = pairs.get(i).getStartTime();
                cameronEnd = pairs.get(i).getEndTime();
                sb.append("C");
            } else if (jamieStart <= pairs.get(i).getEndTime() && jamieEnd <= pairs.get(i).getStartTime() || pairs.get(i).getEndTime() < jamieStart && pairs.get(i).getStartTime() < jamieStart) {
                jamieStart = pairs.get(i).getEndTime();
                jamieEnd = pairs.get(i).getEndTime();
                sb.append("J");
            } else {
                return "IMPOSSIBLE";
            }
           /* if (cameronStart <= pairs.get(i).getEndTime() && cameronEnd <= pairs.get(i).getStartTime()) {
                cameronStart = pairs.get(i).getStartTime();
                cameronEnd = pairs.get(i).getEndTime();
                sb.append("C");
            } else if (jamieStart <= pairs.get(i).getEndTime() && jamieEnd <= pairs.get(i).getStartTime()) {
