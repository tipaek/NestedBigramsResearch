...
public class Solution {
    ...
    public static ArrayList<Integer> split_times(String times) throws Exception {
    ...
    public static boolean checkoverlap(ArrayList<ArrayList<Integer>> list, ArrayList<Integer> checklist) throws Exception {
    ...
    public static boolean testoverlap(int x1, int x2, int y1, int y2) throws Exception {
        return (x1 > y1 && x1 < y2) ||
                (x2 > y1 && x2 < y2) ||
                (y1 > x1 && y1 < x2) ||
                (y2 > x1 && y2 < x2);
