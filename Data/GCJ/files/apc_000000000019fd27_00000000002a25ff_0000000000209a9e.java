...
/*1*/	if (oldLeft == 0 && oldRight == 0 && newLeft == 0) {
			toInvert = 0;
			rightMostUpdated = 0;
		}
/*2*/	else if (oldLeft == 0 && oldRight == 0 && newLeft == 1) {
			toInvert = 1;
			rightMostUpdated = 1;
		}
/*3*/	else if (oldLeft == 0 && oldRight == 1 && newLeft == 0) {
...
/*4*/	else if (oldLeft == 0 && oldRight == 1 && newLeft == 1) {
...
/*5*/	else if (oldLeft == 1 && oldRight == 0 && newLeft == 0) {
			if (toInvert == 0) toFlip = 1;
			if (toInvert == 1) toFlip = 0;
			if (toFlip == 0) toInvert = 1;
			if (toFlip == 1) toInvert = 0;
...
/*6*/	else if (oldLeft == 1 && oldRight == 0 && newLeft == 1) {
			if (toInvert == 0) toFlip = 0;
			if (toInvert == 1) toFlip = 1;
			if (toFlip == 0) toInvert = 0;
			if (toFlip == 1) toInvert = 1;
...
/*7*/	else if (oldLeft == 1 && oldRight == 1 && newLeft == 0) {
			toInvert = 1;
			rightMostUpdated = 0;
		}
/*8*/	else if (oldLeft == 1 && oldRight == 1 && newLeft == 1) {
			toInvert = 0;
			rightMostUpdated = 1;
		}
		else throw new IllegalStateException("We should not be here");
	}
	...
	static String predict() {
		...
		output.setLength(0);
		for (final int bit: result) if (bit < 0) throw new IllegalStateException("empty");
		else output.append(bit);
