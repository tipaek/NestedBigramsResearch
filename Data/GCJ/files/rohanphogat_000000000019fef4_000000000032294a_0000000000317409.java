...
class Testcase{
    ...
    public Testcase(int x, int y, char[] chars, int steps) {
        this.x = x;
        this.y = y;
        this.chars = chars;
        this.steps = steps;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for(int t=0; t<tc; t++){
            ...
            testcase[t] = new Testcase(CX, CY, chars, steps);
        }
        
        for(int t=0; t<tc; t++){
            Testcase tcase = testcase[t];
            int solve = findSolution(tcase.x, tcase.y, tcase.chars, tcase.steps);
