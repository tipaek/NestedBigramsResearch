        ...
        for (int i = 1; i <= t; ++i) {
            ...
            for (int j = 0; j< stringToParse.length(); j++){
                ...
                if (currentParens == value) {
                    ...
                    builder.append(NestingDepth.parenBuilder(true, addedNum));
                    builder.append(value);
                    currentParens = value;
                }
                else{
                    int subNum = currentParens - value;
                    builder.append(NestingDepth.parenBuilder(false, subNum));
                    builder.append(value);
                    currentParens = value;
                }
            }
            builder.append(NestingDepth.parenBuilder(false, currentParens));
