...
class Work {
    ...
    public static Comparator<Work> byTimeComparator = new Comparator<Work>() {
    ...
    public static Comparator<Work> byIndexComparator = new Comparator<Work>() {
...
public class Solution {
    ...
    private static String solve() {
        ...
        if (!workList.isEmpty()) {
            ...
            Collections.sort(workList, Work.byTimeComparator);
            ...
            Collections.sort(workList, Work.byIndexComparator);
            for (final Work work : workList) {
