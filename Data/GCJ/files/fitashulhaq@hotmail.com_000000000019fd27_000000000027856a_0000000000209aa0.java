		...
		for (int i = 1; i <= t; ++i) {
			...
			for (int index=0;index<n;index++)
			{
				for (int j=0;j<n;j++)
				{
					...
					if (index<n-1  && j==0)
					{
						while (value == matrix[index-1][j] || value == matrix[index][j+1] || value == matrix[index+1][j])
						{
							value --;
						...
						while (checkRows(value,matrix,i,j,n) || checkColums(value,matrix,i,j,n))
						{
							value --;
					...
					{
						while (value == matrix[index-1][j] || value == matrix[index][j+1] )
						{
							value --;
					...
					{
						while (value == matrix[index-1][j] || value == matrix[index][j+1] || value == matrix[index][j-1] )
						{
							value --;
					...
					{
						while (value == matrix[index-1][j] || value == matrix[index+1][j] || value == matrix[index][j-1] )
						{
							value --;
					...
					{
						while (value == matrix[index-1][j] || value == matrix[index][j-1] || value == matrix[index][j+1] || value == matrix[index+1][j])
						{
							value --;
