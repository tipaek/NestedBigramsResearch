...
//						System.out.println("Comparing "+Arrays.toString(prefixes.get(i)) +" to "+Arrays.toString(lastPre));
						System.out.println('*');
						continue outer;
					}
				}
...
//						System.out.println("Comparing2 "+Arrays.toString(suffixes.get(i)) +" to "+Arrays.toString(lastSuf));
						System.out.println('*');
						continue outer;
					}
				}
			...
			for (char[] a:centers) for (char c:a) System.out.print(a);
