...
public class Solution {
  ...
  private static long solve() {
    ...
    OptionalLong soFar = OptionalLong.empty();

    for (long multiplier = 1; multiplier < 100; multiplier++) {
      ...
      if (answer.isPresent() && answer.getAsLong() < soFar.getAsLong()) {
        soFar = answer;
      }
    }

    return soFar.orElseGet(() -> diners - 1L);
  }
