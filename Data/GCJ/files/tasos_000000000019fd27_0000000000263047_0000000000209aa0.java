...
public class Solution {
	...
	public static void main(String[] args) {
		...
		for (int caseIndex = 1; caseIndex <= numberOfCases; caseIndex++) {
			...
			List<List<Integer>> permutations = createNaturalLatinSquare(numbers, desiredTrace);
	...
	private static List<List<Integer>> createNaturalLatinSquare(int[] integers, int desiredTrace) {
		...
		int targetDiagonal = desiredTrace / finalResult.size();
