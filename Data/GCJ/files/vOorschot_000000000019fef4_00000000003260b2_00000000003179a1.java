...
//            letters['B' - 'A'].find(1);
    ...
    class found implements Comparable<found>
    {
        ...
        {
            if (foundTotal == 0 && o.foundTotal == 0)
            {
                return 0;
            }
            if (foundTotal != 0 && foundAsFirst == 0 && !(o.foundTotal != 0 && o.foundAsFirst == 0))
            {
                return -1;
            }
            if (o.foundTotal != 0 && o.foundAsFirst == 0 && !(foundTotal != 0 && foundAsFirst == 0))
            {
                return 1;
            }
