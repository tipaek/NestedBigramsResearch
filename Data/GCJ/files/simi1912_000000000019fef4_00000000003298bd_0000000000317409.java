...
class Resolver{
	...
	public String computeAnswear() {
		...
		recursiveSolver.checkForSolution( 0, 0, testCase.X, testCase.Y, testCase.moves.size()-2, 0);
...
class RecursiveSolver{
	...
	public RecursiveSolver(TestCase testCase) {
	...
	public void checkForSolution(int myX, int myY, int X, int Y, int numberOfMovesLeft, int numberOfMovesMade) {
		...
		System.out.println(myX+" "+myY+" "+X+" "+Y+" "+numberOfMovesLeft+" "+numberOfMovesMade);
//		try {
//			Thread.sleep(500);
