                ...
                for (int j1 = 0; j1 < n; j1++) {
                    ...
                    if (map.containsKey(check)) {
                        ...
                        for (int i1 = 0; i1 < ((map.get(check).length() / 2) - 1); i1++) {
                            ...
                            if (!rows.contains(Integer.parseInt(map.get(check).split(" ")[i1])) && Integer.parseInt(map.get(check).split(" ")[i1]) == j) {
                            ...
                            if (!cols.contains(Integer.parseInt(map.get(check).split(" ")[i1 + 1])) && Integer.parseInt(map.get(check).split(" ")[i1 + 1]) == j1) {
