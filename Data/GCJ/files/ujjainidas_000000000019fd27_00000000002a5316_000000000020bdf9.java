        ...
        for(int o = 1; o<=testCases; o++)
        {
            ...
            for(int i = 0; i<numTasks; i++)
            {
                ...
                for(int x = 0; x < J.size(); x++)
                {
                    ...
                    else if(ends[i] > J.get(x)[0] && ends[i] <= J.get(x)[1])
                    {
                        j = false;
                    }
                    ...
                    else if(starts[i] >= J.get(x)[0] && starts[i] < J.get(x)[1])
                    {
                        j = false;
                    }
                    ...
                    else if(starts[i] <= J.get(x)[0] && ends[i] >= J.get(x)[1])
                    {
                        j = false;
                    }
                }
                for (int x = 0; x < C.size(); x++)
                {
                    ...
                    else if(ends[i] > C.get(x)[0] && ends[i] <= C.get(x)[1])
                    {
                        c = false;
                    }
                    ...
                    else if(starts[i] >= C.get(x)[0] && starts[i] < C.get(x)[1])
                    {
                        c = false;
                    }
                    ...
                    else if(starts[i] <= C.get(x)[0] && ends[i] >= C.get(x)[1])
                    {
                        c = false;
                    }
                }
