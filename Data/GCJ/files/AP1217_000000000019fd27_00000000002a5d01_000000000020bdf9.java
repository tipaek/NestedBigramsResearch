    ...
    sortbyColumn(array, 0);
        ...
        for(int i = 0; i < array.length; i++){
            ...
            for(int j = 0; j < nums.length; j++){
                ...
                if(array[i][0] != null && array[i][0] == nums[j]){
        ...
        if(value == 1){
            ...
            System.out.println("Case #" + (val + 1) + ": " + "IMPOSSIBLE");
        }

        // else if(value == 2){

        //     System.out.println("Case #" + (val + 1) + ": " + "CJ");
        // }
            ...
            System.out.println("Case #" + (val+1) + ":" + string);
        }
    }
    System.out.println("Case #" + (val+1) + ": " + "JC");
    }
