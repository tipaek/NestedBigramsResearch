...
public class Solution {
    ...
    static int solve(ArrayList<Slice> slices, int dinners) {
        ...
        // if there are two dinners, means every slice has a different size
        // therefore at least 1 cut! if 1 is divisible by 2 or if you can cut the same size from another slice
        if (dinners == 2) {
            return 1;
        }
        if (dinners == 3) {
