...
public class Solution {
    ...
    private static void solve(){
        ...
        for(int i = 0; i < matSorted.lenght; i++){
            chars[map.get(matSorted[i])] = person;
            
            if(i < matSorted.lenght - 1 && doesOverlap(matSorted[i], matSorted[i+1])){
                if(person == 'J'){
    ...
    private static char getPerson(char c){
        return p == 'J' ? 'C' : 'J';
    }
