...
public class Solution {
    ...
    static class TaskC {
        public void solve(int testNumber, FastScanner in, PrintWriter out) {
            ...
            int n = in.readInt();
            Pair<Integer, Integer> time[] = new Pair[n];

            for (int i = 0; i < n; i++) {
                time[i] = new Pair<>(in.readInt(), in.readInt());
            }

            Arrays.sort(time, (o1, o2) -> o1.getFirst() - o2.getFirst());
            ...
            for (int i = 0; i < n; i++) {
                Pair<Integer, Integer> task = time[i];
                int curTime = task.getFirst();
                ...
                jobEndQueue.add(new Pair<String, Integer>(ppl, task.getSecond()));
            }
