 ...
 */
public class VestigiumCodeJam1 {
    ...
    public static void main(String... args){
        ...
        for(int t=0;t<testCases;t++){
            ...
            scanner.nextLine();
            testCaseIdVskrcMap.put(t,getDuplicateCountAndTrace(array));

        }

        for (Map.Entry<Integer,List<Integer>> m:testCaseIdVskrcMap.entrySet()) {
            System.out.println("Case #"+m.getKey()+": "+m.getValue().stream().map(String::valueOf).collect(Collectors.joining(" ")));
        }
    }
