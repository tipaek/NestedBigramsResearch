            ...
            for ( int column =0; column<n; column++) {
                for (int columnValue1 = 0; columnValue1 < n; columnValue1++) {
                    for (int columnValue2 = 1; columnValue2 < n ; columnValue2++) {
                        System.out.println("spalte: "+column +" erster wert an stelle : "+columnValue1+" " +matrix[columnValue1][column]+ " zweiter wert an stelle : " + columnValue2+" "+ matrix[columnValue2][column]);
