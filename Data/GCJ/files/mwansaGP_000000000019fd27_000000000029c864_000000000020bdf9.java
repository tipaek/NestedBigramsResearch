...
class Solution
{
   public static void main(String args[])
   {
     Scanner input = new Scanner(System.in);
      ...
      for (int n = 0; n < casenum; n++) 
      {
           ...
           java.util.Arrays.sort(matrix, new java.util.Comparator<int[]>() {
   ...
   public static String alo(int[][]a, int N)
   {
        ...
        for (int n = 2; n < N; n++) 
        {
            if(((c.first < a[n][0])&&(c.last > a[n][0] ))||((c.first < a[n][1])&&(c.last > a[n][1]))||(((c.first > a[n][0])&&(c.first < a[n][1]))||((c.last > a[n][0])&&(c.last < a[n][1]))))
            {
                   if(((j.first < a[n][0])&&(j.last > a[n][0] ))||((j.first < a[n][1])&&(j.last > a[n][1]))||(((j.first > a[n][0])&&(j.first < a[n][1]))||((j.last > a[n][0])&&(j.last < a[n][1]))))
                   {
                          return"IMPOSSIBLE";
