        ...
        try {
            ...
            while (t-- > 0){
                ...
                if (u == 2){
                    ...
                    Arrays.sort(p,(a,b) -> (a.val < b.val ? -1 : a.val > b.val ? 1 : 0));
                    ...
                    for (int i=0;i<n;i++){
                        ...
                        if (!used.contains(p[i].digit.charAt(0))){
                            ...
                            map.put((int)p[i].val,p[i].digit.charAt(0));
                        }
                    }
                    ...
                    int n = 10000;
                    Pair p[] = new Pair[n];
                    for (int i=0;i<n;i++)p[i] = new Pair(in.nextLong(),in.next());
                    Arrays.sort(p,(a,b) -> (a.val < b.val ? -1 : a.val > b.val ? 1 : 0));
                    Set<Character> used = new HashSet<>();
                    Map <Integer,Character> map = new HashMap<>();
