...
public class Solution {
    public static void main(String[] args) throws Exception{
        ...
        for (int t = 0; t < tc; t++) {
            long x = in.readLong();
            long y = in.readLong();
            Queue<CellDist> pq = new PriorityQueue<CellDist>(100000, new CellDist());
    ...
    static class CellDist implements Comparator<CellDist>{
        ...
        @Override
        public int compare(CellDist t, CellDist o) {
            return Integer.compare(t.dist, o.dist);
        }
