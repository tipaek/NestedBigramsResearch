    ...
    public static void main(String[] args) {
        ...
        while(in.hasNextInt()) {
            ...
            for (int i = 0; i < tasksList.size(); i++) {
                ...
                int earlist_taskNum = 0;

                for (int j = 0; j < tasksList.size(); j++) {
                    if (tasksList.get(j).startingTime <= earlist){
                        earlist = tasksList.get(j).startingTime;
                        earlist_taskNum = j;
                    }
                }

                orderedTasksList.add(tasksList.get(earlist_taskNum));
                tasksList.remove(earlist_taskNum);
            } */
