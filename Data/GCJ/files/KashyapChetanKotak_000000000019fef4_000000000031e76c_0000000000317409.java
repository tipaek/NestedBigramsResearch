...
public class Solution {
	...
	static void solve() throws Exception {
		...
		for(int i=0;i<m.length();i++) {
			...
			if(currdist<=mindist && (currdist==currtime || currdist==0)) {
				log("is this correct?");
				printlnCase(currtime);
				done=true;
				break;
//				mindist=currdist;
//				minx=fx;miny=fy;
...
//		} else if(minTime!=1 && minTime<mindisttime){
//			printlnCase(minTime);
//		} else {
