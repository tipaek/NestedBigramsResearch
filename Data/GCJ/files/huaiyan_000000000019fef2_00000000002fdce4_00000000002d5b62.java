...
public class Solution {
    ...
    private static String getRes(int x, int y, StringBuilder res) {
    ...
    private static String goHor(int x, StringBuilder res, int y) {
        if (x > 0) {
            x -= step;
            res.insert(0, "E");
        } else {
    ...
    private static String goVer(int x, StringBuilder res, int y) {
        if (y > 0) {
            y -= step;
            res.insert(0, "N");
