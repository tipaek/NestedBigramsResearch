...
class ActivityComparatorByStart implements Comparator<Activity> {
...
class ActivityComparatorOriginal implements Comparator<Activity> {
	...
	public static void main(String[] args) {
		...
		for(int t = 0; t < T; t++) {
			...
			for(int n = 0; n < N; n++) {
				...
				activity.originalIndex = n;
				activities.add(activity);
				
			}
			Collections.sort(activities, new ActivityComparatorByStart());
			Person C = new Person();
			Person J = new Person();
			J.name = "J";
			C.name = "C";
		...
		Collections.sort(activities, new ActivityComparatorOriginal());
