...
public class Solution {
    ...
    public static void solve() throws Exception {
        long low=0, high=2000000000; int c=0;
        while (low<high) {
            if (c==300) System.exit(0);
            long mid=(low+high)/2;
            System.out.println((mid - 1000000000)+" "+0);
        ...
        long lx=low-1000000000;

        low=0; high=2000000000;
        while (low<high) {
            long mid=(low+high)/2;
            System.out.println(0+" "+(mid - 1000000000));
            String x=in.next();
            //if (x.equals("WRONG")) System.exit(0);
            if (x.equals("CENTER")) return;
            if (x.equals("HIT")) {
        ...
        long ly=low-1000000000;

        low=0; high=2000000001;
        while (low<high-1) {
            long mid=(low+high)/2;
            System.out.println((mid - 1000000000)+" "+0);
            String x=in.next();
