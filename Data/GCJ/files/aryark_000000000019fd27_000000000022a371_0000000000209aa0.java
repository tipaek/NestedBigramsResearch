      ...
      for (int a = 0; a < T; a++) {
        ...
        if (N == 2) {
          ...
          if (K == 5 || K == 15) {
            ...
            arr[0] = new int[] {1,3,4,2};
            arr[1] = new int[] {3,2,1,4};
            arr[2] = new int[] {2,4,3,1};
            ...
            arr[0] = new int[] {3,4,1,2};
            arr[1] = new int[] {4,2,3,1};
            arr[2] = new int[] {2,1,4,3};
            arr[3] = new int[] {1,3,2,4};
          } 
        } else {
          if (K == 6 || K == 24) possible = false;
          else if (K == 5) {
            ...
            arr[0] = new int[] {2,1,3,4,5};
            arr[1] = new int[] {1,5,4,2,3};
            arr[2] = new int[] {3,4,5,1,2};
            arr[3] = new int[] {4,3,2,5,1};
            arr[4] = new int[] {5,2,1,3,4};
          } else if (K == 22) {
