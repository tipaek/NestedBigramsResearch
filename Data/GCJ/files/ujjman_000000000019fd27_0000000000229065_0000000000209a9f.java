...
//        	g.print();
        	...
        	int ch=Character.getNumericValue(s.charAt(0)),ch2=0;
        	for(int j=0;j<ch;j++)
    		{
    			st.append("(");
    		}
        	...
        	{
        		ch=Character.getNumericValue(s.charAt(i));
        		ch2=Character.getNumericValue(s.charAt(i+1));
...
//        	if(s.length()>=2)
//        	{
//        		char aa=s.charAt(s.length()-1),bb=s.charAt(s.length()-2);
//            	ch2=Character.getNumericValue(aa);
//            	ch=Character.getNumericValue(bb);
//            	if(ch>ch2)
//        		{
//        			diff=ch-ch2;
//        			for(int j=0;j<diff;j++)
...
//        	}
        	...
        	ch=Character.getNumericValue(aa);
        	for(int i=0;i<ch;i++)
        	{
        		st.append(")");
        	}
        	
        	out.printLine("Case #"+testNumber+": "+st);
