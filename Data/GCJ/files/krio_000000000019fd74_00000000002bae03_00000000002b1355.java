...
public class Solution {
    ...
    private static int solve(int[][] S, int R, int C) {
        int interest = currentInterest(S, R, C);
        int sum = interest;

        while (true) {
            int eliminated = runRound(S, R, C);
    ...
    private static int runRound(int[][] S, int R, int C) {
