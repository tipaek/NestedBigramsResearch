    ...
    public static void main(String[] args) {
        ...
        for (int t = 1; t <= T; ++t) {
            ...
            for (int i = 0;i<n;i++) {
                int a = in.nextInt();
                int b = in.nextInt();
                intervals.add(Interval.of(a, b, i));
            }
...
class Interval {
    ...
    public Interval(int a, int b, int x) {
        l = a;
        r = b;
        id = x;
    }

    public static Interval of(int a, int b, int id) {
        return new Interval(a, b, id);
    }
    ...
    @Override
    public int hashCode() {
        return String.format("%d-%d:%d", l, r, id).hashCode();
    }
