...
public class Solution {
    public static void main(String[] args) {
        ...
        int dots[][] = new int [testCases][testCases];
            ...
            for(index = 0; index< qty; index++) {
                ...
                if (curValue == 1) {
                    if (Math.abs(curX) % 2 == 0 && curY != 0) {
                        if (curY > 0) {
                            if (reverseFlag) { result += "S"; curY += 1; }
                            else {result += "N";curY -= 1; }
                        } else {
                            if (reverseFlag) {result += "N"; curY -= 1; }
                            else { result += "S"; curY += 1; }
                        }
                    } else {
                        if (curX > 0) {
                            if (reverseFlag) { result += "W"; curX += 1;}
                            else {result += "E";  curX -= 1;}
                        } else {
                            if (reverseFlag) { result += "E";  curX -= 1;}
