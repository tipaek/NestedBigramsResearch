...
class util{
    ...
    Boolean recurse(int one, int two, int sum){
        ...
        int value = binomialCoeff(one-1,two-1);
    ...
    void solve(int a,int iteration){
        ArrayList<int[]> ans = recurseUtils(1,1,a);
