...
//            if(!flag)break;
            ...
            for(int[] pos:q[t]){
                ...
                if((pr = row[i].prev(j)) != -1 && remove(skill, row, col, i, pr)){
                    q[t^1].add(new int[]{i, pr});
                }
                if((pr = row[i].next(j)) != -1 && remove(skill, row, col, i, pr)){
                    q[t^1].add(new int[]{i, pr});
                }
                if((pr = col[j].prev(i)) != -1 && remove(skill, row, col, pr, j)){
                    q[t^1].add(new int[]{pr, j});
                }
                if((pr = col[j].next(i)) != -1 && remove(skill, row, col, pr, j)){
                    q[t^1].add(new int[]{pr, j});
                }
            }
            t ^= 1;
