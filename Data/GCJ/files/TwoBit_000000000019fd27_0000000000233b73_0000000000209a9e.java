        ...
        for(int currCase = 1; currCase <= T; currCase++)
        {
           ...
           {   
               ...
               {                              
                    if(pairA == -1 || difA == -1)
                    {       
                        //System.out.println("Different or same pair missing, falling to default");
                    ...
                    {
                        //System.out.println("checking different known pair and same known pair");
                        ...
                        {
                           // System.out.println("no complement or reversal found");
                        }
                    }
               }else
               {      
