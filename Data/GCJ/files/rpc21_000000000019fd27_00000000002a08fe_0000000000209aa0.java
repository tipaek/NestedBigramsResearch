...
//                        System.out.println("58");
                        helper(n, fiveTimes, smallerOnce, largerOnce, k, grid);
                        return;
                    }
//                    System.out.println(smallerOnce);
...
//                    System.out.println(largerOnce);
                    ...
                    if(k==n+2){
                        helper(n, 1, 2, 3, k, grid);
                    }
                    else if(k==n*n-2){
                        helper(n, n, n-1, n-2, k, grid);
                    }
...
//                    System.out.println(largerOnce);
    ...
    private static void helper(int n, int fiveTimes, int smallerOnce, int largerOnce, int k, String[][] grid) {
