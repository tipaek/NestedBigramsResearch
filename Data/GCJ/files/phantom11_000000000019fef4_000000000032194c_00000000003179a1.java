...
public class Solution {
    ...
    static class TaskB {
        ...
        public char[] solvefirst(int Q[], String R[], int length[], HashSet<Character> characters) {
            int N = 10000;
        ...
        public char[] solveNotImpossible(int Q[], String R[], int length[], HashSet<Character> characters) {
            int N = 10000;
            char result[] = new char[10];
            HashSet<Character> used = new HashSet<>();
            for (int i = 0; i < N; i++) {
                if (length[i] == 16) {
                    result[1] = R[i].charAt(0);
                }
            }
            int index = 0;
            Character perm[] = new Character[9];
