...
//		System.err.println("cur:" + cur + " visitedI:" + Arrays.toString(visitedI) + "visitedO:" + Arrays.toString(visitedO));
		...
		for (int i = 0; i < N; i++) {
			...
			if (connect[i] != -1 && cur != connect[i]) continue;
...
//			System.err.println("cur:" + cur + " i:" + i + " next:" + next);
...
//		System.err.println("cur:" + cur + " visitedI:" + Arrays.toString(visitedI) + "visitedO:" + Arrays.toString(visitedO) + " dx:" + dx + " dy:" + dy);
	}
