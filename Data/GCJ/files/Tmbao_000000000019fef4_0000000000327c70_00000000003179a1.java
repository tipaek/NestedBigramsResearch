    ...
    static final class Overrandomized {
        ...
        public void solve(int testNumber, Scanner in, PrintWriter out) {
            ...
            for (int i = 0; i < recordSize; ++i) {
                records.add(new Overrandomized.Record(in.nextInt(), in.next()));
            }
            ...
            for (int rep = 0; rep < 10; ++rep) {
                for (int i = 0; i < recordSize; ++i) {
                    ...
                    syncSecret(secret, record.r);

                    // Update the first digit
                    secret.get(record.r.charAt(0)).removeRange(0, 0);
