...
public class Solution
{
    ...
    public static HashMap<Interval,Character> eraseOverlapIntervals(Interval[] intervals,char var){
//    erase or return non overlapping
        sortIntervalByEndValue(intervals);
        int intervalsRemoved=0;
        int lastValidIntervalIndex=0,prv=0;
        HashMap<Interval,Character> res=new HashMap<>();
...
//            if(x[lastValidIntervalIndex]=='\0') {
                Interval mapStr = intervals[lastValidIntervalIndex];
...
//            System.out.println(Arrays.toString(ar));
            ...
            HashMap<Interval,Character> res=eraseOverlapIntervals(intervals,C);
...
//            }
            ...
            while (hmIterator.hasNext()){
                ...
                Interval str=(Interval)mapElement.getKey();
//                System.out.println(Arrays.toString(str));
                int start1=str.start;
                int end1=str.end;
