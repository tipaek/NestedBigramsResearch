...
public class Solution {
    ...
    public static Map<Pair<Integer, Integer>, Character> schedule(List<Pair<Integer, Integer>> sortedHours) {
        ...
        for (int i = 1; i < sortedHours.size(); ++i) {
            if (J != null && sortedHours.get(i).getKey() >= J.getValue() && sortedHours.get(i).getKey() >= C.getValue() ) {
            ...
            } else if (sortedHours.get(i).getKey() >= C.getValue() ) {
                m.put(sortedHours.get(i), 'C');
                C = sortedHours.get(i);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; ++i) {
            int N = in.nextInt();
            List<Pair<Integer, Integer>> hours = readHours(in, N);
