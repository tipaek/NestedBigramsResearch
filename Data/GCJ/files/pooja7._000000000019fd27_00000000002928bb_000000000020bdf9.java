...
//                        }
            ...
            if(flag == 1) {
                ...
                for(int i=0; i<real.size(); i++) {
                    Integer key = real.get(i).getKey();
                    Integer value = real.get(i).getValue();
                    for(int j=0; j<alist.size(); j++) {
                        Integer ele = alist.get(j).getKey();
                        Integer eleValue = alist.get(j).getValue();
                        if((key.equals(ele)) && (value.equals(eleValue))) {
