    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < T; i++) {
            ...
            for (int j = 0; j < noOfPatterns; j++) {
                ...
                StringBuilder s = new StringBuilder(sb.reverse().substring(0, sb.length()-1));
            ...
            for(String s : list){
                int len = s.length();
                if(!maxString.substring(0,len).equals(s)){
                    maxString = new StringBuilder("*");
                    break;
                }
            }

            pr.pw.println("Case #" + (i + 1) + ": " + maxString.reverse().toString());
        }
        pr.pw.close();
    }
}
