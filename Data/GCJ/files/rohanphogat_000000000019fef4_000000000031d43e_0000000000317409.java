...
public class Solution {
    ...
    private static int findRecur(int currTime, int fx, int fy, int cx, int cy, char[] chars, int steps, MultiKeyMap multiMap){
        ...
        int solN = findRecur(currTime+1, fx + directionMap.get('N').get(0), fy + directionMap.get('N').get(1), newcx, newcy, chars, steps, multiMap);
        int solE = findRecur(currTime+1, fx + directionMap.get('E').get(0), fy + directionMap.get('E').get(1), newcx, newcy, chars, steps, multiMap);
        int solW = findRecur(currTime+1, fx + directionMap.get('W').get(0), fy + directionMap.get('W').get(1), newcx, newcy, chars, steps, multiMap);
        int solS = findRecur(currTime+1, fx + directionMap.get('S').get(0), fy + directionMap.get('S').get(1), newcx, newcy, chars, steps, multiMap);
