...
public class Solution {
    ...
    void go(int x, int y, int i, StringBuilder sb) {
        if (stop || i > 7) return;
        if (x == xx && y == yy) {
            stop = true;
            ans = sb;
        ...
        go(x - (1 << i), y, i + 1, sb.append("W"));
        go(x + (1 << i), y, i + 1, sb.append("E"));
        go(x, y - (1 << i), i + 1, sb.append("S"));
        go(x, y + (1 << i), i + 1, sb.append("N"));
    }
