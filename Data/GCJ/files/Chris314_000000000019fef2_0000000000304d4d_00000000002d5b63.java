...
public class Solution {
  public static void solve(Scanner input, int A, int B, int upperLeft[], int bottomRight[], int size) {
     ...
     if (s.equals("HIT")) {
         solve(input, A, B, upperLeft, new int[]{  (upperLeft[0] + bottomRight[0]+1)/2, (upperLeft[1] + bottomRight[1]+1)/2}, (size+1)/2);
         return;
     }
     ...
     if (s.equals("HIT")) {
         solve(input, A, B, new int[] {(upperLeft[0] + bottomRight[0] + 1)/2 ,upperLeft[1]         }, new int[]{bottomRight[0], (upperLeft[1] + bottomRight[1]+1)/2}, (size+1)/2);
         return;
     }
     ...
     if (s.equals("HIT")) {
         solve(input, A, B,   new int[]{  (upperLeft[0] + bottomRight[0]+1)/2, (upperLeft[1] + bottomRight[1]+1)/2}  ,bottomRight, (size+1)/2);
         return;
     }
     ...
     if (s.equals("HIT")) {
         solve(input, A, B,   new int[]{upperLeft[0], (upperLeft[1] + bottomRight[1]+1)/2}, new int[] {(upperLeft[0] + bottomRight[0] + 1)/2 ,bottomRight[1]         },(size+1)/2);
         return;
     }
  ...
  public static void main(String args[]) {
    ...
    for (int ks = 1; ks <= T; ks++) {
        ...
        else solve(input,A,B, initUpperLeft, initBottomRight, 101);
    }
  }
}