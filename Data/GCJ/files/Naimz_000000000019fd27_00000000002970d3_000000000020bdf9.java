...
public class Solution {
    ...
    static boolean intervalDansListe(Intervalle intervalle, ArrayList<Intervalle> liste) {
        ...
        for (int i = 0; i < liste.size(); i++) {
            ...
            if ((intervalle.deb == liste.get(i).deb) || (intervalle.fin == liste.get(i).fin) || (intervalle.deb > liste.get(i).deb && intervalle.deb < liste.get(i).fin) || (intervalle.fin > liste.get(i).deb && intervalle.fin < liste.get(i).fin) || ((intervalle.deb) == (liste.get(i).deb) && (intervalle.fin) == (liste.get(i).fin))) {
