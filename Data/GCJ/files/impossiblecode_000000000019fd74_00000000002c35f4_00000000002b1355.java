...
public class Solution {
    ...
    public static long solve() throws Exception {
        ...
        removed=new boolean[r][c]; inq=new boolean[r][c];
        ans=0;
    ...
    public static void update(int a, int b, int c) {
        if (ppc[a][b]!=-1 && shouldremove(ppc[a][b], b) && !inq[ppc[a][b]][b]) {
        ...
        if (ppr[a][b]!=-1 && shouldremove(a, ppr[a][b]) && !inq[a][ppr[a][b]]) {
        ...
        if (apc[a][b]!=-1 && shouldremove(apc[a][b], b) && !inq[apc[a][b]][b]) {
        ...
        if (apr[a][b]!=-1 && shouldremove(a,apr[a][b]) && !inq[a][apr[a][b]]) {
