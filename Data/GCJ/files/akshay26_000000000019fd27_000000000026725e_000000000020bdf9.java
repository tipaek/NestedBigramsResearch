  ...
  public static void main(String[] args) {
     	...
     	for(int t=1;t<=test;t++){
     	    int n=sc.nextInt();
     	   	...
     	   	for(int i=0;i<n;i++) {
     	   	    ...
     	   	    inp[i]=Integer.toString(time[i].getFirstName())+" "+Integer.toString(time[i].getLastName())+" "+Integer.toString(i);
     	   	}
    ...
    for (Name nn : times) {
     ...
     int in=nn.getIndex();
      ...
      if(c<=s) {
           map.put(Integer.toString(s)+" "+Integer.toString(e)+" "+Integer.toString(in),"C");
         c=e;
     }
      else if(j <= s) {
         map.put(Integer.toString(s)+" "+Integer.toString(e)+" "+Integer.toString(in),"J");
         j=e;
     }
     else {
         flag=true;
