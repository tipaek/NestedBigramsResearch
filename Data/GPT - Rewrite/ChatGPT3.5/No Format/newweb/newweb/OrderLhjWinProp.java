...
public class OrderLhjWinProp {
    ...
    private String operation; // Data operation type (create: first order submission, add: addition during order modification, update: updated during order modification)
