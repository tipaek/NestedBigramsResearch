...
public class PhraseOMatic {
    ...
    public static void main(String[] args) {
        ...
        String phrase = generateRandomPhrase(wordListOne, wordListTwo, wordListThree);
        System.out.println("What we need is a " + phrase);
    }

    private static String generateRandomPhrase(String[] wordListOne, String[] wordListTwo, String[] wordListThree) {
