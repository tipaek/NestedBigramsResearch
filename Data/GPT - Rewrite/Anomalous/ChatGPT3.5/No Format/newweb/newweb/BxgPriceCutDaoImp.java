...
public class BxgPriceCutDaoImp implements BxgPriceCutDao {
    ...
    @Override
    public BxgPriceCut selectBxgPriceCutByBxgIdAndCustomerID(int bxgID, int customerID) {
        Query query = sessionFactory.getCurrentSession()
                .createSQLQuery("select * from t_bxgpricecut where bxgid=? and customerid=?").addEntity(BxgPriceCut.class);
