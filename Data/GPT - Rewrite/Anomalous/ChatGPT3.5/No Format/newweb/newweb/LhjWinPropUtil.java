...
public class LhjWinPropUtil {
    ...
    private static void setWinPropFields(OrderLhjWinProp model, JSONObject winProp) throws NumberFormatException, JSONException {
    ...
    private static void pushWinProp(OrderLhjWinProp model, JSONObject winProp, MaterialBrandService materialBrandService,
            String brandID, String typeForBrandID, String windowsBuyType) throws NumberFormatException, JSONException {
        model.setMaterialBrand(materialBrandService.findMaterialBrandById(Integer.parseInt(brandID)));
        model.setTypeForBrand(materialBrandService.findTypeForBrandById(Integer.parseInt(typeForBrandID)));
        model.setWindowsBuyType(windowsBuyType);
        setWinPropFields(model, winProp);
    }
    ...
    public static List<OrderLhjWinProp> pushJsonDataToModel(JSONArray winProps, String brandID, String typeForBrandID,
            String windowsBuyType, MaterialBrandService materialBrandService) throws NumberFormatException, JSONException {
        List<OrderLhjWinProp> list = new ArrayList<>();
    ...
    public static List<OrderLhjWinProp> pushJsonDataToModel(JSONArray winProps, String brandID, String typeForBrandID,
            String windowsBuyType, String orderID, MaterialBrandService materialBrandService, OrderService orderService)
