 ...
 * se debe mostrar el contenido de ese array junto al índice (0 – 9). Seguidamente, el programa debe colocar
 * en las últimas posiciones los números que terminen en 7 dejando el resto en las primeras posiciones.
 *
 * @Costy
 */
...
public class SieteFinal {
    public static void main(String[] args) {
        ...
        // Se guardan los números en un array
