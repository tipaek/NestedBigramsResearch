...
# using NBKL3 structure and efficiency except for BeN
def beNSlide(file_path, groupLength, eps=1e-9):
            ...
            for i, code_group in enumerate(code_groups):
                ...
                for node in nodes:
                    ...
                    for token_group in token_groups:
                        ...
                        if node_dict.get(str_token_group) == None:
                            node_dict[str_token_group] = index_numRows[0]
                            index_numRows[0] += 1
